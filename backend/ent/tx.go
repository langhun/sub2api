...
func (tx *Tx) init() {
	...
	tx.ProxySubscriptionNode = NewProxySubscriptionNodeClient(tx.config)
	tx.ProxySubscriptionSource = NewProxySubscriptionSourceClient(tx.config)
	...
	tx.UserBankAccount = NewUserBankAccountClient(tx.config)
