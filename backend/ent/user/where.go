...
// GameHallDisabled applies equality check predicate on the "game_hall_disabled" field. It's identical to GameHallDisabledEQ.
func GameHallDisabled(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldGameHallDisabled, v))
}
...
// GameHallDisabledEQ applies the EQ predicate on the "game_hall_disabled" field.
func GameHallDisabledEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldGameHallDisabled, v))
}

// GameHallDisabledNEQ applies the NEQ predicate on the "game_hall_disabled" field.
func GameHallDisabledNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldGameHallDisabled, v))
}
