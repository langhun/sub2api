...
type User struct {
	...
	// GameHallDisabled holds the value of the "game_hall_disabled" field.
	GameHallDisabled bool `json:"game_hall_disabled,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled, user.FieldGameHallDisabled:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldGameHallDisabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field game_hall_disabled", values[i])
			} else if value.Valid {
				_m.GameHallDisabled = value.Bool
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("game_hall_disabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.GameHallDisabled))
	builder.WriteByte(')')
