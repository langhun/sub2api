...
type UserEdges struct {
	...
	// CheckinBlindboxRecords holds the value of the checkin_blindbox_records edge.
	CheckinBlindboxRecords []*CheckinBlindboxRecord `json:"checkin_blindbox_records,omitempty"`
...
// CheckinBlindboxRecordsOrErr returns the CheckinBlindboxRecords value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) CheckinBlindboxRecordsOrErr() ([]*CheckinBlindboxRecord, error) {
	if e.loadedTypes[10] {
		return e.CheckinBlindboxRecords, nil
	}
	return nil, &NotLoadedError{edge: "checkin_blindbox_records"}
}
...
// was not loaded in eager-loading.
func (e UserEdges) LedgerAccountsOrErr() ([]*LedgerAccount, error) {
	if e.loadedTypes[17] {
...
// was not loaded in eager-loading.
func (e UserEdges) LedgerEntriesOrErr() ([]*LedgerEntry, error) {
	if e.loadedTypes[18] {
...
// QueryCheckinBlindboxRecords queries the "checkin_blindbox_records" edge of the User entity.
func (_m *User) QueryCheckinBlindboxRecords() *CheckinBlindboxRecordQuery {
	return NewUserClient(_m.config).QueryCheckinBlindboxRecords(_m)
}
...
// QueryLedgerAccounts queries the "ledger_accounts" edge of the User entity.
func (_m *User) QueryLedgerAccounts() *LedgerAccountQuery {
	return NewUserClient(_m.config).QueryLedgerAccounts(_m)
}

// QueryLedgerEntries queries the "ledger_entries" edge of the User entity.
func (_m *User) QueryLedgerEntries() *LedgerEntryQuery {
