...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gameHallStore := repository.NewGameHallRepository(client, db)
	gameHallService := service.ProvideGameHallService(gameHallStore, settingService)
	gameHandler := handler.ProvideGameHandler(gameHallService)
