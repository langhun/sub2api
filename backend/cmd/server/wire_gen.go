...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	mihomoAdminService := service.ProvideMihomoAdminService(adminService)
	mihomoService := service.NewMihomoService(settingRepository, proxySubscriptionSourceRepository, mihomoAdminService)
	proxyHandler := handler.ProvideAdminProxyHandler(adminService, mihomoService)
