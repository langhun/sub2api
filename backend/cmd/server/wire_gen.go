...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	mihomoService := service.NewMihomoService(settingRepository, proxySubscriptionSourceRepository, adminService)
	proxyHandler := admin.NewProxyHandler(adminService, mihomoService)
