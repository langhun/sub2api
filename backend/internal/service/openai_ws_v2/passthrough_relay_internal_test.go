...
func TestShouldParseUsageTerminalEvents(t *testing.T) {
	...
	require.False(t, shouldParseUsage("response.incomplete"))
	require.False(t, shouldParseUsage("response.cancelled"))
	require.False(t, shouldParseUsage("response.canceled"))
