...
func (s *OpenAIGatewayService) SelectAccountByPreviousResponseID(
	...
	return s.selectAccountByPreviousResponseIDForCapability(s.withOpenAIQuotaAutoPauseContext(ctx), groupID, previousResponseID, requestedModel, excludedIDs, "", requireCompact)
}
