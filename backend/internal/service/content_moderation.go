...
func (s *ContentModerationService) UpdateConfig(ctx context.Context, input UpdateContentModerationConfigInput) (*ContentModerationConfigView, error) {
	...
	if input.ModelFilter != nil {
		cfg.ModelFilter = normalizeContentModerationModelFilter(*input.ModelFilter)
	}
...
func (s *ContentModerationService) Check(ctx context.Context, input ContentModerationCheckInput) (*ContentModerationDecision, error) {
	...
	if !cfg.includesModel(input.Model) {
		slog.Info("content_moderation.skip_model_out_of_scope",
			...
			"protocol", input.Protocol,
			"model", input.Model,
			"model_filter", cfg.ModelFilter.Type,
...
func defaultContentModerationConfig() *ContentModerationConfig {
	return &ContentModerationConfig{
		...
		ModelFilter:          ContentModerationModelFilter{Type: ContentModerationModelFilterAll, Models: []string{}},
	}
}
...
func (cfg *ContentModerationConfig) includesModel(model string) bool {
	...
	if filter.Type == ContentModerationModelFilterAll {
		return true
	}
	...
	if filter.Type == ContentModerationModelFilterInclude {
		return matched
	}
	return !matched
}
...
func normalizeContentModerationModelFilter(filter ContentModerationModelFilter) ContentModerationModelFilter {
	normalized := ContentModerationModelFilter{
		...
		Models: normalizeContentModerationModelList(filter.Models),
	}
	...
	if normalized.Type == ContentModerationModelFilterAll {
		normalized.Models = []string{}
	}
	return normalized
}

func normalizeContentModerationModelList(models []string) []string {
