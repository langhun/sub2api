...
type BalanceTransferRepository interface {
	...
	DeductBalanceIfSufficient(ctx context.Context, userID int64, amount float64) (bool, error)
...
type BalanceRedPacketRepository interface {
	...
	GetByCodeForUpdate(ctx context.Context, code string) (*RedPacketRecord, error)
	GetByID(ctx context.Context, id int64) (*RedPacketRecord, error)
	DecrementClaim(ctx context.Context, id int64, amount float64) (*RedPacketRecord, error)
