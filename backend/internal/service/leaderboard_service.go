...
func (s *LeaderboardService) GetBalanceLeaderboard(ctx context.Context, page, pageSize int, includeAdmin bool) (*LeaderboardResult, error) {
	return s.getBalanceLeaderboardFromUsers(ctx, page, pageSize, includeAdmin)
}

func (s *LeaderboardService) getBalanceLeaderboardFromUsers(ctx context.Context, page, pageSize int, includeAdmin bool) (*LeaderboardResult, error) {
