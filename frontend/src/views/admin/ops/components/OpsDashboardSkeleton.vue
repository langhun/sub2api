  ...
  <div class="space-y-6">
    ...
    <div :class="['rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900/30 lg:col-span-5">
        ...
        <div class="lg:col-span-7">
          <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="i in 6" :key="i" class="h-20 animate-pulse rounded-xl bg-gray-50 dark:bg-dark-900/30"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
      <div :class="['min-h-[360px] rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700 lg:col-span-1', props.fullscreen ? 'p-8' : 'p-6']">
        ...
        <div class="mt-6 h-72 animate-pulse rounded-xl bg-gray-100 dark:bg-dark-700/70"></div>
      </div>
      <div :class="['min-h-[360px] rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700 lg:col-span-1', props.fullscreen ? 'p-8' : 'p-6']">
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
        <div class="mt-6 h-72 animate-pulse rounded-xl bg-gray-100 dark:bg-dark-700/70"></div>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      ...
      >
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
        <div class="mt-6 h-56 animate-pulse rounded-xl bg-gray-100 dark:bg-dark-700/70"></div>
      </div>
    </div>
    ...
    <div :class="['rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div class="mt-6 space-y-3">
        <div v-for="i in 6" :key="i" class="flex items-center justify-between gap-4 rounded-xl bg-gray-50 p-4 dark:bg-dark-900/30">
