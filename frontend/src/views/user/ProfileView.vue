  ...
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <transition name="modal">
        <div v-if="showProfileLuckModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" @click.self="showProfileLuckModal = false">
          <div class="mx-4 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-dark-800">
            ...
            <div class="mt-5 flex gap-3">
              <button type="button" class="flex-1 rounded-xl border border-gray-300 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-dark-600 dark:text-dark-300 dark:hover:bg-dark-700" @click="showProfileLuckModal = false">{{ t('common.cancel') || 'Cancel' }}</button>
