    ...
    <div class="lottery-page mx-auto max-w-7xl space-y-5">
      ...
      <main class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_24rem]">
        <section class="lottery-panel">
          ...
          <div class="space-y-5 pt-4">
            <div>
              ...
              <div class="ball-grid" data-testid="red-ball-grid">
                <button
            ...
            <div>
              ...
              <div class="ball-grid" data-testid="blue-ball-grid">
                <button
        ...
        <aside class="lottery-panel">
          ...
          <div class="mt-4 space-y-3">
            <div v-if="ordersLoading" class="empty-row">加载中</div>
            <div v-else-if="orders.length === 0" class="empty-row">暂无投注记录</div>
            <article v-for="order in orders" v-else :key="order.order_id" class="record-row">
      ...
      <section class="lottery-panel">
        ...
        <div class="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          <div v-if="resultsLoading" class="empty-row md:col-span-2 xl:col-span-3">加载中</div>
          <div v-else-if="results.length === 0" class="empty-row md:col-span-2 xl:col-span-3">暂无开奖记录</div>
          <article v-for="result in results" v-else :key="result.issue_no" class="record-row">
...
function readableError(error: unknown) {
  const value = error as { message?: string; reason?: string }
