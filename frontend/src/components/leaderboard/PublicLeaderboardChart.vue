...
.leaderboard-summary-card {
  ...
  overflow: hidden;
  background:
    linear-gradient(180deg, color-mix(in oklch, var(--card) 92%, white) 0%, color-mix(in oklch, var(--muted) 88%, white) 100%);
  border: 1px solid color-mix(in oklch, var(--border) 82%, white);
  box-shadow:
    inset 0 1px 0 color-mix(in oklch, white 70%, transparent),
    0 10px 24px oklch(0 0 0 / 5%);
}
...
.leaderboard-summary-card::before {
  ...
  pointer-events: none;
  background:
    radial-gradient(circle at top left, color-mix(in oklch, oklch(0.92 0.05 210) 32%, transparent) 0%, transparent 42%),
    linear-gradient(90deg, transparent 0%, color-mix(in oklch, white 22%, transparent) 100%);
}
...
:global(.dark) .leaderboard-summary-card {
  background:
    linear-gradient(180deg, color-mix(in oklch, var(--card) 94%, black) 0%, color-mix(in oklch, var(--muted) 82%, var(--card)) 100%);
  border-color: color-mix(in oklch, var(--border) 88%, transparent);
  box-shadow:
    inset 0 1px 0 color-mix(in oklch, white 10%, transparent),
    0 14px 30px oklch(0 0 0 / 18%);
}

:global(.dark) .leaderboard-summary-card::before {
  background:
    radial-gradient(circle at top left, color-mix(in oklch, oklch(0.52 0.06 220) 24%, transparent) 0%, transparent 44%),
    linear-gradient(90deg, transparent 0%, color-mix(in oklch, white 6%, transparent) 100%);
}
