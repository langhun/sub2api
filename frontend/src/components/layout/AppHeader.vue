...
const userInitials = computed(() => {
  ...
  return getPreferredUserDisplayName(user.value).substring(0, 2).toUpperCase()
})

const displayName = computed(() => {
  if (!user.value) return ''
  return getPreferredUserDisplayName(user.value)
})
