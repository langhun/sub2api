  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-gray-300 px-2 py-1 text-xs text-gray-500 hover:border-gray-200 hover:text-gray-700 dark:border-dark-600 dark:text-gray-400 dark:hover:border-gray-200 dark:hover:text-gray-700"
          @click="addRow"
        >
    ...
    <div v-if="bodyOverrideMode !== 'off'">
      <div class="mb-1 flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-xs text-gray-700 hover:underline disabled:cursor-not-allowed disabled:text-gray-400 disabled:no-underline dark:text-gray-300"
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  if (active) {
    return 'border-gray-200 bg-gray-100 text-gray-700 dark:bg-dark-700 dark:text-gray-300 dark:border-dark-600'
  }
  return 'border-gray-200 bg-white text-gray-600 hover:border-gray-200 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400'
}
