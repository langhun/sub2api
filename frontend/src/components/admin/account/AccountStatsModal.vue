<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 dark:bg-dark-800 p-3 dark:border-dark-600"
      >
        <div class="flex items-center gap-3">
          <div
            class="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50 dark:bg-dark-800"
          >
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-gray-200 bg-gray-50 p-4 dark:border-dark-600 dark:bg-dark-800"
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="dollar" size="sm" class="text-gray-700 dark:text-gray-300" />
              </div>
            </div>
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="bolt" size="sm" class="text-gray-700 dark:text-gray-300" />
              </div>
            </div>
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="clock" size="sm" class="text-gray-700 dark:text-gray-300" />
              </div>
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="fire" size="sm" class="text-gray-600 dark:text-gray-300" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="cube" size="sm" class="text-gray-700 dark:text-gray-300" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-gray-100 p-1.5 dark:bg-dark-700">
                <Icon name="bolt" size="sm" class="text-gray-600 dark:text-gray-300" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
