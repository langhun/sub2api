  ...
  >
      ...
      <div>
        ...
        <div class="flex gap-2">
          <div class="relative flex-1">
            ...
            <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1 transition-colors hover:bg-gray-100 dark:hover:bg-dark-700" :class="passwordCopied ? 'text-gray-700' : 'text-gray-400'">
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        ...
        <button type="submit" form="edit-user-form" :disabled="submitting" class="btn btn-secondary">
