  ...
  <div v-if="allEndpoints.length > 0" class="flex flex-wrap gap-2">
    ...
    >
      ...
      <div class="group/endpoint relative flex items-center gap-1.5">
        <div
          class="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 w-max max-w-[24rem] -translate-x-1/2 translate-y-1 rounded-xl border border-[var(--border)] bg-[var(--card)] px-3 py-2.5 text-left opacity-0 shadow-sm ring-1 ring-[var(--border)] transition-all duration-150 group-hover/endpoint:translate-y-0 group-hover/endpoint:opacity-100 group-focus-within/endpoint:translate-y-0 group-focus-within/endpoint:opacity-100 dark:border-[var(--border)] dark:bg-[var(--card)] dark:ring-[var(--border)]"
        >
          <p
          ...
          <div class="absolute left-1/2 top-full h-3 w-3 -translate-x-1/2 -translate-y-1/2 rotate-45 border-b border-r border-[var(--border)] bg-[var(--card)] dark:border-slate-700 dark:bg-slate-900"></div>
        </div>
