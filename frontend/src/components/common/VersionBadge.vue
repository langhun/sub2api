    ...
    <template v-if="isAdmin">
      ...
      <transition name="dropdown">
        <div
          v-if="dropdownOpen"
          ref="dropdownRef"
          class="absolute left-0 z-50 mt-2 w-64 overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--card)] shadow-sm"
        >
            ...
            <template v-else>
              ...
              <div class="mb-4 text-center">
                <div class="inline-flex items-center gap-2">
                  ...
                  <span
                    v-if="!hasUpdate"
                    class="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--muted)]"
                  >
                    <svg
                      class="h-3 w-3 text-[var(--foreground)]"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
              ...
              <div v-if="updateError" class="space-y-2">
                <div
                  class="flex items-center gap-3 rounded-lg border border-[var(--border)] bg-[var(--muted)] p-3"
                >
                  <div
                    class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-[var(--card)]"
                  >
                    <Icon
                      name="x"
                      size="sm"
                ...
                <button
                  @click="handleUpdate"
                  :disabled="updating"
                  class="flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--foreground)] px-4 py-2 text-sm font-medium text-[var(--background)] transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {{ t('version.retry') }}
                </button>
              </div>
              ...
              <div v-else-if="updateSuccess && needRestart" class="space-y-2">
                ...
                >
                  ...
                  >
                    <svg
                      class="h-4 w-4 text-[var(--foreground)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      stroke-width="2"
                ...
                <button
                  @click="handleRestart"
                  :disabled="restarting"
                  class="flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--primary)] px-4 py-2 text-sm font-medium text-[var(--primary-foreground)] transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <svg
                    v-if="restarting"
              ...
              <div v-else-if="hasUpdate && !isReleaseBuild" class="space-y-2">
                <a
                  ...
                  class="group flex items-center gap-3 rounded-lg border border-[var(--border)] bg-[var(--muted)] p-3 transition-colors hover:bg-[var(--card)]"
                >
                  <div
                    class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-[var(--card)]"
                  >
                  ...
                  <svg
                    class="h-4 w-4 text-[var(--muted-foreground)] transition-transform group-hover:translate-x-0.5"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                ...
                <!-- Source build hint -->
                <div
                  class="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--muted)] p-2"
                >
                  <svg
                    class="h-3.5 w-3.5 flex-shrink-0 text-[var(--muted-foreground)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
