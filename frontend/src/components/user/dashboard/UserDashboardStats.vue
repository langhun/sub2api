  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        <div class="feature-icon feature-icon-success h-9 w-9 rounded-lg p-2">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="feature-icon feature-icon-purple h-9 w-9 rounded-lg p-2">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="feature-icon feature-icon-info h-9 w-9 rounded-lg p-2">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="feature-icon feature-icon-warning h-9 w-9 rounded-lg p-2">
        ...
        <div>
          ...
          <p class="text-xs">
            ...
            <span class="text-gray-900 dark:text-white" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
...
function quotaBarClass(p: number): string {
  if (p >= 95) return 'bg-[var(--foreground)]'
  if (p >= 75) return 'bg-gray-500 dark:bg-gray-400'
