  ...
  <BaseDialog :show="show" :title="t('checkin.luckTitle')" width="narrow" :close-on-click-outside="true" @close="emit('close')">
    ...
    <div class="space-y-4">
      ...
      <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
        ...
        <button type="button" class="text-gray-600 hover:text-gray-700 dark:text-gray-400" @click="betAmount = balanceLimit">
          MAX
        </button>
      </div>
    ...
    <template #footer>
      <div class="flex flex-row items-center justify-end gap-3">
        ...
        <button
          ...
          class="rounded-xl bg-[var(--primary)] px-5 py-2.5 text-sm font-semibold text-[var(--primary-foreground)] shadow-sm transition-opacity hover:opacity-90 disabled:opacity-50"
          @click="handleSubmit"
        >
