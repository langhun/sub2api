export default {
  ...
  admin: {
    ...
    users: {
      ...
      signupSourceLabel: 'Signup Source',
      signupSourceEmail: 'Email',
      signupSourceLinuxdo: 'LinuxDo',
      signupSourceWechat: 'WeChat',
      signupSourceOidc: 'OIDC',
      signupSourceGithub: 'GitHub',
      signupSourceGoogle: 'Google',
      signupSourceDingtalk: 'DingTalk',
      signupSourceUnknown: 'Unknown',
      inviterLabel: 'Inviter',
      noInviter: 'None',
      amountSourceTotal: 'Total Credited',
      amountSourceRecharge: 'Recharge',
      amountSourceRegistration: 'Registration Bonus',
      amountSourceInvitation: 'Invitation Code',
      amountSourceCheckin: 'Check-in Rewards',
      amountSourceAffiliateTransfer: 'Affiliate Transfer',
      amountSourceAdminAdjustment: 'Admin Adjustment',
      roles: {
        admin: 'Admin',
        user: 'User'
      },
