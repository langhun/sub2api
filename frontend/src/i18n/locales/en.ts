  ...
  admin: {
    ...
    proxies: {
      ...
      subscriptions: {
        ...
        tab: 'Node Subscriptions',
        linkedBadge: 'Subscription managed',
          modalHint: 'Manage node subscriptions here. Saving, refreshing, and deleting sources updates the proxy list.',
        productHint: 'This node subscription creates proxy entries after refresh and syncs them into the proxy list.',
          create: 'New Node Subscription',
        empty: 'No node subscriptions',
        ...
        managedReadonlyHint: 'This proxy is managed by a node subscription. Connection fields are read-only, but you can still change status and pool membership.',
          createTitle: 'Node Subscription',
          editTitle: 'Edit Node Subscription',
        nodesTitle: 'Subscription Nodes',
        nodesEmpty: 'No nodes',
        refreshSuccess: 'Refresh complete: {nodes} nodes, {proxies} proxies',
        refreshSyncSuccess: 'Refresh complete: {nodes} nodes, {proxies} proxies, created {created}, reused {reused}',
        refreshSyncPartial: 'Refresh complete, but proxy entry sync failed: {detail}',
        refreshFailed: 'Failed to refresh node subscription',
        nodesLoadFailed: 'Failed to load subscription nodes',
        deleteSuccess: 'Node subscription deleted',
        deleteSyncSuccess: 'Node subscription deleted and proxy entries synced (created {created}, reused {reused})',
        deleteSyncPartial: 'Node subscription deleted, but proxy entry sync failed: {detail}',
        deleteFailed: 'Failed to delete node subscription',
        createSuccess: 'Node subscription created',
        createSyncSuccess: 'Node subscription created and proxy entries synced (created {created}, reused {reused})',
        createSyncPartial: 'Node subscription created, but proxy entry sync failed: {detail}',
        createFailed: 'Failed to create node subscription',
        updateSuccess: 'Node subscription updated',
        updateSyncSuccess: 'Node subscription updated and proxy entries synced (created {created}, reused {reused})',
        updateSyncPartial: 'Node subscription updated, but proxy entry sync failed: {detail}',
        updateFailed: 'Failed to update node subscription',
        formSections: {
