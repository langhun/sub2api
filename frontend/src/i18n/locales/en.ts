  ...
  admin: {
    ...
    proxies: {
      ...
      subscriptions: {
        ...
        tab: 'Subscriptions',
        linkedBadge: 'Managed by subscription',
        modalHint: 'Manage subscription sources here. Saving, refreshing, and deleting sources updates the proxy list.',
        productHint: 'This source creates proxy entries after refresh and syncs them into the proxy list.',
        ...
        deleteSyncSuccess: 'Subscription source deleted and proxy entries synced (created {created}, reused {reused})',
        deleteSyncPartial: 'Subscription source deleted, but proxy entry sync failed: {detail}',
        deleteFailed: 'Failed to delete subscription source',
        createSuccess: 'Subscription source created',
        createSyncSuccess: 'Subscription source created and proxy entries synced (created {created}, reused {reused})',
        createSyncPartial: 'Subscription source created, but proxy entry sync failed: {detail}',
        createFailed: 'Failed to create subscription source',
        updateSuccess: 'Subscription source updated',
        updateSyncSuccess: 'Subscription source updated and proxy entries synced (created {created}, reused {reused})',
        updateSyncPartial: 'Subscription source updated, but proxy entry sync failed: {detail}',
