  ...
  admin: {
    ...
    proxies: {
      ...
      mihomo: {
        ...
        sourceHint: 'Project Mihomo now reuses the subscription sources below as its only input. There is no separate URL list anymore. Saving, refreshing, or deleting a source here now triggers a linked Mihomo sync automatically.',
      ...
      subscriptions: {
        ...
        modalHint: 'Project Mihomo reuses these subscription sources as its only data source; save, refresh, and delete actions now auto-sync Mihomo.',
