export default {
  ...
  bank: {
    ...
    description: 'View account snapshots, credit capacity, and unified ledger transactions',
    readonlyBadge: 'Read-only Preview',
    refresh: 'Refresh financial data',
    accountSnapshot: 'Account Snapshot',
    transactionLedger: 'Ledger Transactions',
    balance: 'Available Balance',
    availableCapacity: 'Available Capacity',
    frozenAmount: 'Frozen Funds',
    creditLimit: 'Credit Limit',
    totalDebt: 'Total Debt',
    debtPrincipal: 'Debt Principal',
    debtInterest: 'Debt Interest',
    status: 'Account Status',
    legacyMissing: 'Legacy Account',
    legacyMissingYes: 'Pending sync',
    legacyMissingNo: 'Synced',
    typeFilter: 'Transaction Type',
    moduleFilter: 'Business Module',
    allTypes: 'All Types',
    ...
    reference: 'Reference',
    noTransactions: 'No ledger transactions yet',
    loadFailed: 'Failed to load finance center',
    transactionsLoadFailed: 'Failed to load ledger transactions',
    statusMap: {
      ACTIVE: 'Active',
      FROZEN: 'Frozen',
      CLOSED: 'Closed'
    ...
    txTypes: {
      ...
      LEND_INVEST: 'Lending Investment',
      LEND_PROFIT: 'Lending Profit',
      REWARD: 'Reward',
      REFUND: 'Refund',
      FREEZE: 'Freeze',
      UNFREEZE: 'Unfreeze'
  ...
  monitorCommon: {
    ...
    past: 'PAST',
    now: 'NOW',
    maintenancePaused: 'Maintenance 路 timeline paused',
  ...
  checkin: {
    ...
    luckDesc: 'Bet an amount and get a random multiplier between x{min} and x{max}',
    luckSuccess: 'Lucky check-in! Multiplier x{multiplier}, earned ${amount}',
    luckLoss: 'Lucky check-in! Multiplier x{multiplier}, lost ${amount}',
    luckEven: 'Lucky check-in! Multiplier x1.00, no change',
    luckCheckinReward: 'Lucky Check-in Reward',
    luckRewardTitle: 'Lucky Check-in Reward 路 Multiplier x{multiplier}',
    betAmount: 'Bet Amount',
    betAmountPlaceholder: 'Enter bet amount',
    multiplier: 'Multiplier',
    multiplierRange: 'Multiplier range x{min} ~ x{max}',
    ...
    blindboxInvitationReward: 'Invitation code 脳1',
  ...
  leaderboard: {
    ...
    empty: 'No data yet',
    tabsDisabled: 'Leaderboard tabs are disabled',
    balanceChartTitle: 'Balance Distribution',
    balanceChartSubtitle: "See each ranked user's balance share",
    consumptionChartTitle: 'Consumption Distribution',
    consumptionChartSubtitle: 'See how all spending users contribute in the current period',
    checkinChartTitle: 'Check-in Distribution',
    checkinChartSubtitle: "See each ranked user's streak share",
    totalAmount: 'Total Amount',
    totalUsers: 'Users',
    hoverHint: 'Hover slices to inspect the user, amount, and share',
    checkinHoverHint: 'Hover slices to inspect the user, streak days, and share',
    requests: 'Requests',
    checkins: 'Check-ins',
    ...
    checkinSubtitle: '{total} total 路 last {date} 路 earned ${reward}',
  ...
  admin: {
    ...
    groups: {
      ...
      accountsTotal: 'Total:',
      accountsUnit: '',
      rateAndAccounts: '{rate}x rate 路 {count} accounts',
      ...
      imagePricing: {
        ...
        modeHint: 'By default, image billing uses image price 脳 current effective group multiplier. Independent mode uses image price 脳 image multiplier.',
    ...
    channelMonitor: {
      ...
      historyLoadError: 'Failed to load check history',
      ...
      pageStatusTitle: 'Automatic check status',
      pageStatusEnabled: 'Running',
      pageStatusDisabled: 'Disabled',
      pageStatusDescription: 'This page auto-refreshes so you can see the latest automatic check time and result directly.',
      pageStatusDisabledDescription: 'Global channel monitoring is currently disabled, so background automatic checks will not run.',
      autoRefreshHint: 'Page refresh in {seconds}s',
      columns: {
        name: 'Name',
        provider: 'Provider',
        primaryModel: 'Primary Model',
      ...
      historyTitleWithName: 'Check History 路 {name}',
      historySubtitle: 'Recent automatic check results',
      historyDescription: 'Shows the most recent persisted results from automatic or manual checks for this monitor.',
      historyAllModels: 'All models',
      historyEmpty: 'No check history yet',
      historyCheckedAt: 'Checked at',
      historyLatency: 'Model latency',
      historyPingLatency: 'Ping latency',
    ...
    accounts: {
      ...
      duplicateCheck: {
        ...
        scopeHint: 'Scans all accounts in account management by default, independent of the current page. Empty filters mean no limit.',
        platforms: 'Platform filter',
        statuses: 'Status filter',
        groups: 'Group filter',
        emptyMeansAll: 'No selection means all.',
        includeInactive: 'Include inactive and error accounts',
        statusHint: 'When specific statuses are selected, the scan uses them. Otherwise the inactive toggle controls status scope.',
        noGroups: 'No groups',
        run: 'Run Check',
        checking: 'Checking...',
        totalAccounts: 'Scanned',
        duplicateAccounts: 'Duplicate accounts',
        groupsFound: 'Duplicate groups',
        strongGroups: 'Strong groups',
        weakGroups: 'Weak groups',
        noDuplicates: 'No duplicate accounts found.',
        strong: 'Strong',
        weak: 'Weak',
        groupScope: '{platform} / {type}, {count} accounts',
        accountId: 'Account ID',
        failed: 'Duplicate account check failed',
      ...
      status: {
        ...
        streamTimeoutCooldown: 'Stream Timeout Cooldown',
        tokenRefreshCooldown: 'Refresh Cooldown',
        quotaExceeded: 'Quota Exceeded',
        unschedulable: 'Unschedulable',
        schedulingActive: 'Currently in scheduling',
        manualPausedHint: 'Scheduling has been turned off manually',
        expiredPausedHint: 'Account expired and was auto-paused',
        quotaExceededHint: 'Quota exhausted and removed from scheduling',
        rateLimitedUntil: 'Rate limited and removed from scheduling. Auto resumes at {time}',
        rateLimitedAutoResume: 'Auto resumes in {time}',
        overloadedAutoResume: 'Auto resumes in {time}',
        tempUnschedAutoResume: '{reason}, auto resumes in {time}',
      ...
      statusGuide: {
        ...
        runtimeNormal: 'There is currently no cooldown or temporary block',
        ...
        runtimeOauth401Cooldown: '401 auth cooldown, usually leaving room for token refresh or re-auth',
        runtimeForbiddenCooldown: '403 cooldown, usually a temporary rejection or risk-control cooldown',
        runtimeHttpCooldown: 'Temporary cooldown triggered by upstream HTTP {code}',
        runtimeStreamTimeoutCooldown: 'Temporary cooldown triggered by stream timeout',
        runtimeTokenRefreshCooldown: 'Temporary cooldown after token refresh retries were exhausted',
        runtimeQuotaExceeded: 'Account quota is exceeded and removed from scheduling',
      ...
      bulkActions: {
        ...
        test: 'Test Selected',
        testAllUngrouped: 'Test Ungrouped',
          testUngroupedPrefix: 'Test count',
          testUngroupedCountHint: 'Total {total} accounts',
          resetStatus: 'Reset Status',
          refreshToken: 'Refresh Token',
          setPrivacy: 'Set Privacy',
          clearPrivacy: 'Clear Privacy',
          confirmSetPrivacy: 'Set privacy for the selected accounts? Only OpenAI OAuth accounts will be processed.',
          confirmClearPrivacy: 'Clear privacy status for the selected accounts? Only OpenAI OAuth accounts will be processed.',
          ...
          partialSuccessWithSkipped: 'Partially completed: {success} succeeded, {failed} failed, {skipped} skipped'
        },
      batchTest: {
        ...
        progress: 'Progress',
        model: 'Test model',
        defaultModelOption: 'Default model per account',
        concurrency: 'Concurrency',
        ...
        loadTargetsFailed: 'Failed to load accounts for batch testing',
        noAccountsToTest: 'No accounts match the current filter',
        loadingTargets: 'Preparing test accounts...',
        result: 'Result',
        ...
        successWithModel: 'Test passed: {model}',
        successWithModelAndText: 'Test passed: {model}, response {text}',
        failedMessage: 'Test failed',
        incompleteStream: 'Test stream did not complete',
      ...
      quotaControl: {
        ...
        rpmLimit: {
          ...
          strategyTieredHint: 'Green 鈫?Yellow 鈫?Sticky only 鈫?Blocked, progressive throttling',
      ...
      proxy: 'Proxy',
      proxyAutoFailoverAt: 'Auto-switched {time} ago',
      noProxy: 'No Proxy',
      concurrency: 'Concurrency',
      ...
      oauth: {
        ...
        step4: 'Find Cookies 鈫?https://claude.ai',
    ...
    proxies: {
      ...
      allStatus: 'All Status',
      allRuntimeStatus: 'All Runtime Status',
      allHealth: 'All Health',
      failedStatus: 'Failed',
      poolEnabled: 'In Pool',
      poolDisabled: 'Not In Pool',
      enableAction: 'Enable Proxy',
      disableAction: 'Disable Proxy',
      poolEnableAction: 'Add to Pool',
      poolDisableAction: 'Remove from Pool',
      poolMembersAction: 'View Pool',
      poolMembersTitle: 'Pool Members',
      poolMembersSummary: '{count} proxies are currently in the failover pool',
      poolMembersFilteredSummary: 'Showing {visible} of {total} proxies',
      poolMembersEmpty: 'There are no proxies in the failover pool yet',
      poolMembersFilteredEmpty: 'No proxies match the current filters',
      poolMembersMeta: 'Runtime Info',
      poolMembersHealth: 'Health',
      poolMembersSwitchCount: 'Switch Hits',
      poolMembersRecovered: 'Last Recovery',
      poolMembersSearchPlaceholder: 'Search name / address / failure reason',
      poolToggleLabel: 'Participate in automatic failover pool',
      poolToggleHint:
        'Only proxies added to this pool can be selected automatically for OpenAI and Antigravity failover.',
      poolUsageSummary: 'OpenAI and Antigravity accounts automatically use the proxy pool',
      poolUsageHint:
        'If the account current proxy fails, the system switches to a healthy proxy in the pool. If the account has no proxy, it can also pick one directly from the pool.',
      poolBatchEnabled: 'Added {count} proxies to the automatic failover pool',
      poolBatchDisabled: 'Removed {count} proxies from the automatic failover pool',
      poolSingleEnabled: 'Added {name} to the automatic failover pool',
      poolSingleDisabled: 'Removed {name} from the automatic failover pool',
      poolUpdateFailed: 'Failed to update proxy pool membership',
      protocols: {
        http: 'HTTP',
        https: 'HTTPS',
        socks5: 'SOCKS5',
      ...
      toolsMenu: 'Tools',
      batchActionsMenu: 'Batch Actions',
      accountName: 'Account',
      accountPlatform: 'Platform',
      accountNotes: 'Notes',
      mihomo: {
        title: 'Mihomo',
        manage: 'Multi-port Proxy',
        multiPortTitle: 'Multi-port Proxy',
        multiPortDescription: 'Local multi-port proxy assignment',
        summaryPorts: '{count} ports',
        summaryProtocol: 'Protocol {protocol}',
        summaryConfigFile: 'Config file {path}',
        configPathPending: 'Pending sync',
        configure: 'Configure',
        syncToProxy: 'Sync to Proxies',
        summary: 'Reuse subscription sources as Mihomo multi-port entries',
        summaryHint: '{count} listeners',
        sourceCountHint: '{count} enabled sources',
        sourceNodesHint: '{count} enabled source nodes',
        protocolLabel: 'Protocol: {protocol}',
        sourcePanelTitle: 'Proxy Source',
        sourceNamePlaceholder: 'Subscription source name',
        sourceUrlPlaceholder: 'Subscription source URL',
        sourcePanelHint: 'This panel reuses the subscription sources below as the multi-port proxy data source, so there is no second config list.',
        autoRouteTitle: 'Auto-pick Routes',
        autoRouteDescription: 'Let Mihomo choose available routes by latency for stable day-to-day operation.',
        failoverTolerance: 'Failover tolerance (ms)',
        healthCheckInterval: 'Health check interval (sec)',
        excludeNodesTitle: 'Excluded Nodes',
        excludeNodesDescription: 'Record node keywords that should stay out of auto-pick. This is currently UI guidance only and is not sent to the backend config.',
        excludeNodesPlaceholder: 'One keyword per line, for example:\nHong Kong\nHK\nHKG\nTaiwan',
        listenerPanelTitle: 'Listener Ports',
        listenerLineTitle: 'Port {port} Route',
        sourceHint: 'Subscription sources below are reused as the only input. There is no separate URL list anymore. Saving, refreshing, or deleting a source here now triggers a linked Mihomo sync automatically.',
        workspaceTitle: 'Unified entry workspace',
        workspaceDescription: 'Manage subscription sources, provider generation, and Mihomo listener entries in one product surface for config, sync, and troubleshooting.',
        workspaceStatus: 'Latest linked refresh',
        workspaceStatusEmpty: 'No refresh yet',
        statusBadge: {
          loading: 'Loading',
          error: 'Error',
        ...
        statusMessage: {
          loading: 'Loading workspace data, please wait.',
          healthy: 'The workspace looks healthy and is ready for save or sync.',
          latestRefresh: 'Latest linked refresh: {time}',
          noEnabledSources: 'No enabled source is available for linked sync.',
          sourceErrors: '{count} sources need to be fixed before sync.',
          listenerIncomplete: '{count} listener entries are still missing region preferences.',
          disabledSources: '{count} sources are currently disabled.'
        },
        refreshSources: 'Refresh sources',
        listenerCompletion: '{ready}/{total} listeners completed',
        flow: {
          sourcesTitle: '1. Subscription sources',
          sourcesDesc: 'Maintain the only source of truth and handle create, edit, refresh, and delete here.',
          providersTitle: '2. Provider build',
          providersDesc: 'The backend generates provider files from enabled sources as the only Mihomo input.',
          listenersTitle: '3. Local listener entries',
          listenersDesc: 'Nodes are assembled into multi-port listener entries and synced into the proxy list.'
        },
        overview: {
          sources: 'Enabled sources',
          sourcesHint: 'Sources currently participating in Mihomo generation',
          listeners: 'Listeners',
          listenersHint: 'Generated sequentially starting from port {start}',
          nodes: 'Available nodes',
          nodesHint: 'Total nodes aggregated from enabled sources after refresh',
          materialized: 'Materialized entries',
          materializedHint: 'Entries already synced into the proxy table',
          errorsHint: '{count} sources need attention'
        },
        sourceSectionTitle: 'Unified source of truth',
        sourceSectionDescription: 'All subscription sources are maintained here. Create, edit, refresh, and delete actions continue into Mihomo and the proxy table.',
        sourceHealthTitle: 'Current source health',
        sourceHealthNormal: 'No source issue needs action right now.',
        sourceHealthError: '{count} sources are currently unhealthy.',
        sourceActionHintTitle: 'Suggested action',
        sourceActionHint: 'Fix unhealthy sources first, then save and sync for a more stable rollout.',
        sourceMetaTitle: 'Latest linked info',
        sourceSectionStats: '{total} sources in total, {enabled} enabled',
        sourceSectionNodeStats: '{count} nodes aggregated, {materialized} entries materialized',
        sourceSectionEmpty: 'No subscription source is available yet. Create one first, then sync everything into Mihomo.',
        configSectionTitle: 'Mihomo runtime config',
        configSectionDescription: 'Keep runtime parameters and listener planning on the right so they do not compete with source operations.',
        configGroups: {
          connection: 'Connection and naming',
          listeners: 'Listener entries',
          strategy: 'Location optimization'
        },
        optimizeSectionTitle: 'Strategy and optimization',
        listenerSectionTitle: 'Location assignment',
        listenerSectionDescription: 'This uses the same location language as the proxy table: each port can target a country, region, or city and overrides the default location above.',
        listenerSummaryTitle: 'Listener summary',
        listenerSummaryDescription: 'Check whether entries are complete before editing individual region preferences.',
        listenerSummaryReady: 'Completed listeners',
        listenerSummaryMissing: 'Missing locations',
        listenerSummaryMissingValue: '{count} listeners still need locations',
        listenerSummaryMissingNone: 'All listeners already have locations',
        listenerStatusReady: 'Ready',
        listenerStatusPending: 'Pending',
        listenerPortLabel: 'Port {port}',
        listenerRegionLabel: 'Location',
        listenerGenerateTitle: 'Listener generation',
        listenerGenerateDescription: 'Set the start port and listener count first, then complete region preferences one by one.',
        saveHint: 'Save Config updates Mihomo runtime settings only. Save and Sync rebuilds providers, listener entries, and the proxy-table mapping from currently enabled sources.',
        ...
        proxyNamePrefix: 'Proxy Name Prefix',
        listenerPorts: 'Listener Ports',
        listenerRegion: 'Location for port {port}',
        regionAuto: 'Auto Select',
        regionPlaceholder: 'Select or enter location',
        selectLocation: 'Default location',
        locationPlaceholder: 'Enter or select location',
        locationDisabledByAutoOptimize: 'Auto optimization is enabled, so the default location is not used. Turn it off to pin a location.',
        autoOptimize: 'Auto Optimize',
        countryOptimize: 'Optimize by Location',
        optimizeSettings: 'Optimization Settings',
        enableAutoOptimize: 'Enable Auto Optimization',
        autoOptimizeHint: 'Generate url-test strategy groups and let Mihomo choose available nodes by latency.',
        applyAutoOptimize: 'Auto-optimize strategy',
        selectCountry: 'Default location',
        countryPlaceholder: 'Enter or select location',
        applyRecommendedCountry: 'Auto-pick location',
        recommendedCountryHint: 'Recommended: {country}',
        recommendedLocationHint: 'Recommended: {location}',
        recommendedCountryEmpty: 'No location is available yet. Save and sync can populate it from config later.',
        autoFillListenerRegions: 'Auto-fill locations',
        save: 'Save Config',
        saveAndSync: 'Save and Sync',
        loadFailed: 'Failed to load Mihomo config',
        saveSuccess: 'Mihomo config saved',
        saveFailed: 'Failed to save Mihomo config',
        syncSuccess: 'Mihomo synced: created {created}, reused {reused}',
        syncFailed: 'Failed to sync Mihomo'
      },
      subscriptions: {
        title: 'Subscription Sources',
        tab: 'Subscriptions',
        manage: 'Mihomo Subscriptions',
        manageTitle: 'Mihomo Subscriptions',
        manageHint: 'Manage proxy subscription sources in one place; saving, refreshing, or deleting will sync proxy entries and Mihomo config.',
        linkedBadge: 'Linked to Mihomo',
        modalHint: 'These subscription sources are reused as the only data source; save, refresh, and delete actions now auto-sync Mihomo.',
        productHint: 'This source directly participates in Mihomo provider generation and will trigger a linked sync after save.',
        create: 'New Subscription',
        empty: 'No subscription sources',
        refreshInterval: 'Refresh interval: {hours}h',
        targetEntryCount: 'Target entries: {count}',
        nodeCount: 'Nodes: {count}',
        materializedCount: 'Materialized proxies: {count}',
        nodeMetricTitle: 'Node total',
        targetMetricTitle: 'Target entries',
        refreshMetricTitle: 'Refresh cycle',
        lastRefreshed: 'Last refreshed: {time}',
        lastRefreshedEmpty: 'Last refreshed: none',
        lastSuccess: 'Last success: {time}',
        lastSuccessEmpty: 'Last success: none',
        refreshNow: 'Refresh now',
        viewNodes: 'View nodes',
        statusHealthy: 'Healthy',
        statusError: 'Sync error',
        statusPending: 'Pending first sync',
        managedBadge: 'Managed by subscription',
        managedReadonlyHint: 'This proxy is managed by a subscription source. Connection fields are read-only, but you can still change status and pool membership.',
        createTitle: 'Create Subscription Source',
        editTitle: 'Edit Subscription Source',
        nodesTitle: 'Subscription Nodes',
        nodesEmpty: 'No nodes',
        refreshSuccess: 'Refresh complete: {nodes} nodes, {proxies} proxies',
        refreshSyncSuccess: 'Refresh complete: {nodes} nodes, {proxies} proxies; Mihomo synced (created {created}, reused {reused})',
        refreshSyncPartial: 'Refresh complete, but linked Mihomo sync failed: {detail}',
        refreshFailed: 'Failed to refresh subscription source',
        nodesLoadFailed: 'Failed to load subscription nodes',
        deleteSuccess: 'Subscription source deleted',
        deleteSyncSuccess: 'Subscription source deleted and Mihomo synced (created {created}, reused {reused})',
        deleteSyncPartial: 'Subscription source deleted, but linked Mihomo sync failed: {detail}',
        deleteFailed: 'Failed to delete subscription source',
        createSuccess: 'Subscription source created',
        createSyncSuccess: 'Subscription source created and Mihomo synced (created {created}, reused {reused})',
        createSyncPartial: 'Subscription source created, but linked Mihomo sync failed: {detail}',
        createFailed: 'Failed to create subscription source',
        updateSuccess: 'Subscription source updated',
        updateSyncSuccess: 'Subscription source updated and Mihomo synced (created {created}, reused {reused})',
        updateSyncPartial: 'Subscription source updated, but linked Mihomo sync failed: {detail}',
        updateFailed: 'Failed to update subscription source',
        formSections: {
          basic: 'Basic information',
          policy: 'Sync and materialization policy'
        },
        fields: {
          name: 'Name',
          ...
          autoAddToPool: 'Automatically add to proxy pool'
        },
        formats: {
          auto: 'Auto Detect',
          directList: 'Direct Proxy List',
          uriList: 'URI List / Base64',
          clashYaml: 'Clash / Mihomo YAML'
        }
      },
      assignAccounts: {
        open: 'Evenly Assign to Accounts',
        title: 'Evenly Assign to Accounts',
        scopeHint: '{count} proxies selected. Target accounts are limited to accounts without a proxy, and execution rechecks this guard to avoid overwrites.',
        platforms: 'Platform filter',
        statuses: 'Status filter',
        groups: 'Group filter',
        emptyMeansAll: 'No selection means all.',
        noGroups: 'No groups',
        groupOrHint: 'Multiple groups use OR logic. Accounts matching several groups are assigned only once.',
        preview: 'Preview',
        ...
        planned: 'Planned',
        actual: 'Actual',
        emptyTargets: 'No unproxied target accounts match the current filters.',
        unnamedProxy: 'Unnamed proxy',
        proxyCountChange: 'Accounts {before} 鈫?{after}; planned {planned}, actual {assigned}',
        moreAccounts: '{count} more accounts',
        previewFailed: 'Failed to preview proxy assignment',
        assignSuccess: 'Assigned {count} accounts',
      ...
      statusEnabled: 'Proxy enabled successfully',
      statusDisabled: 'Proxy disabled successfully',
      ...
      qualityInterpretation: 'Interpretation',
      ...
      qualityInterpretationHealthy: 'Connectivity looks healthy and ready for scheduling.',
      qualityInterpretationWarn: 'The target is reachable, but authentication or method limits apply.',
      qualityInterpretationChallenge: 'The proxy triggered an upstream protection challenge and may be unstable.',
      qualityInterpretationFail: 'At least one target failed and the proxy should be investigated.',
      qualityItemMessageEmpty: 'No extra details',
      healthHealthy: 'Healthy',
      healthCooldown: 'Cooldown',
      healthFailed: 'Failed',
      healthUnknown: 'Unknown',
      cooldownUntil: 'Cooldown: {time}',
      cooldownExpired: 'expired',
      clearCooldownAction: 'Clear Cooldown',
      cooldownClearedSingle: 'Proxy cooldown cleared',
      cooldownClearedBatch: 'Cleared cooldown for {count} proxies',
      cooldownClearFailed: 'Failed to clear proxy cooldown',
      failoverSwitchCount: 'Auto failover hits: {count}',
      lastFailure: 'Last Failure',
      lastRecoveredAt: 'Last recovery: {time}',
      lastRecoveredEmpty: 'No recovery record yet',
      ...
      failedToToggle: 'Failed to toggle proxy status',
      ...
      deleteConfirm:
        "Are you sure you want to delete '{name}'? Only proxies not in use can be deleted. If you need to detach accounts first, use Quick Unassign."
    },
    ...
    redeem: {
      ...
      sourceUnknown: 'No source recorded',
      winnerLine: 'Winner: {user}',
      prizeLine: 'Prize: {prize}',
      usedByLine: 'Registered by: {user}',
      inviterLine: 'Inviter: {user}',
    ...
    ops: {
      ...
      responseTail: 'Response tail',
      responseLatencyLabel: 'Response latency (ms)',
      p50: 'p50:',
      p90: 'p90:',
      p95: 'p95:',
      p99: 'p99:',
      ...
      settings: {
        ...
        slowTailIsolation: 'Slow Tail Isolation',
        enableSlowTailIsolation: 'Enable slow tail isolation',
        slowTailIsolationHint: 'Temporarily unschedule high-latency accounts based on P95 within the window; set duration / response thresholds to 0 to disable those dimensions.',
        slowTailWindowMinutes: 'Window (minutes)',
        slowTailMinRequests: 'Minimum sample count',
        slowTailTempUnschedMinutes: 'Temp unsched duration (minutes)',
        slowTailMaxAccountsPerRun: 'Max isolated accounts per run',
        slowTailTTFTP95Threshold: 'TTFT P95 threshold (ms)',
        slowTailDurationP95Threshold: 'Duration P95 threshold (ms, 0 = off)',
        slowTailResponseLatencyP95Threshold: 'Response P95 threshold (ms, 0 = off)',
        ...
        validation: {
          ...
          slowTailWindowMinutesRange: 'Slow tail window must be between 1 and 120 minutes',
          slowTailMinRequestsRange: 'Slow tail minimum samples must be between 1 and 100',
          slowTailTTFTP95ThresholdRange: 'Slow tail TTFT P95 threshold must be between 100 and 120000 ms',
          slowTailDurationP95ThresholdRange: 'Slow tail duration P95 threshold must be between 0 and 600000 ms',
          slowTailResponseLatencyP95ThresholdRange: 'Slow tail response P95 threshold must be between 0 and 600000 ms',
    ...
    transfer: {
      ...
      freeze: 'Freeze',
      revoke: 'Revoke',
      freezeTitle: 'Freeze Transfer',
      freezeConfirm:
        'Freeze this transfer? The receiver balance will be deducted and returned to the sender.',
      revokeTitle: 'Revoke Transfer',
      revokeConfirm: 'Revoke this transfer?',
      searchUser: 'Search email / username',
      amount: 'Amount',
      ...
      redpacket: 'Red Packet',
      batch: 'Batch Distribute',
      loadFailed: 'Failed to load',
      freezeSuccess: 'Freeze succeeded',
      freezeFailed: 'Freeze failed',
      adminRevoke: 'Admin revoke',
      revokeSuccess: 'Revoke succeeded',
      revokeFailed: 'Revoke failed',
      noValidTargets: 'Please add at least one valid target',
      batchSuccess: 'Batch distribution succeeded',
      batchFailed: 'Batch distribution failed'
    },
    settings: {
      ...
      site: {
        ...
        homeNavKeyUsageEnabledHint: 'Show or hide the Key Usage link in the public home page header.',
        homeNavMonitoringEnabled: 'Show Platform Monitoring Link',
        homeNavMonitoringEnabledHint: 'Show or hide the Platform Monitoring link in the public home page header.',
        homeNavPricingEnabled: 'Show Model Pricing Link',
        homeNavPricingEnabledHint: 'Show or hide the Model Pricing link in the public home page header.',
        leaderboardTabsTitle: 'Leaderboard Tabs',
        leaderboardTabsHint: 'Control the four tabs shown inside the leaderboard page separately.',
        leaderboardBalanceEnabled: 'Show Balance Tab',
        leaderboardBalanceEnabledHint: 'Show or hide the Balance tab on the leaderboard page.',
        leaderboardConsumptionEnabled: 'Show Consumption Tab',
        leaderboardConsumptionEnabledHint: 'Show or hide the Consumption tab on the leaderboard page.',
        leaderboardTransferEnabled: 'Show Transfer Tab',
