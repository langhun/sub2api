export default {
  ...
  monitorCommon: {
    ...
    past: 'PAST',
    now: 'NOW',
    maintenancePaused: 'Maintenance 璺?timeline paused',
  ...
  checkin: {
    ...
    luckRewardTitle: 'Lucky Check-in Reward 璺?Multiplier x{multiplier}',
    ...
    blindboxInvitationReward: 'Invitation code 鑴?',
  ...
  leaderboard: {
    ...
    checkinSubtitle: '{total} total 璺?last {date} 璺?earned ${reward}',
  ...
  admin: {
    ...
    groups: {
      ...
      accountsTotal: 'Total:',
      accountsUnit: '',
      rateAndAccounts: '{rate}x rate 璺?{count} accounts',
      ...
      imagePricing: {
        ...
        modeHint: 'By default, image billing uses image price 鑴?current effective group multiplier. Independent mode uses image price 鑴?image multiplier.',
    ...
    channels: {
      ...
      form: {
        ...
        webSearchEmulationGlobalDisabled: 'Please enable the global switch first in Settings 閳?Gateway 閳?Web Search Emulation',
    ...
    channelMonitor: {
      ...
      historyTitleWithName: 'Check History 璺?{name}',
    ...
    accounts: {
      ...
      quotaControl: {
        ...
        rpmLimit: {
          ...
          strategyTieredHint: 'Green 閳?Yellow 閳?Sticky only 閳?Blocked, progressive throttling',
      ...
      oauth: {
        ...
        step4: 'Find Cookies 閳?https://claude.ai',
    ...
    proxies: {
      ...
      subscriptions: {
        ...
        manageTitle: 'Proxy Subscription Sources',
        manageHint: 'Manage subscription source refresh, node inspection, deletion, and materialized proxy entries here.',
        modalHint: 'Manage subscription source refresh, node inspection, deletion, and materialized proxy entries here.',
      ...
      assignAccounts: {
        ...
        proxyCountChange: 'Accounts {before} 閳?{after}; planned {planned}, actual {assigned}',
