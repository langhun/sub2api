  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        homeNavLinksEnabled: 'Show Home Header Links',
        homeNavLinksEnabledHint: 'Show Leaderboard, Key Usage, Platform Monitoring, and Model Pricing links in the public home page header.',
