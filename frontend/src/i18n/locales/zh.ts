export default {
  ...
  "admin": {
    ...
    "accounts": {
      ...
      "proxyModePoolEmpty": "当前代理池里还没有代理。请先到 IP管理里把代理加入自动切换池。",
    ...
    "proxies": {
      ...
      "mihomo": {
        ...
        "sourceHint": "Project Mihomo 直接复用下方订阅源作为唯一数据源，不再单独维护第二套订阅 URL。订阅源在这里保存、刷新、删除后会自动联动同步到 Mihomo。",
      ...
      "subscriptions": {
        ...
        "modalHint": "Project Mihomo 直接复用这里的订阅源作为唯一数据源；保存、刷新、删除后会自动联动同步 Mihomo。",
