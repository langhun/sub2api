...
=======
      ...
      "createdAt": "创建时间",
      "totalRecharged": "总充值",
      "signupSourceLabel": "注册方式",
      "signupSourceEmail": "邮箱注册",
      "signupSourceLinuxdo": "LinuxDo",
      "signupSourceWechat": "微信",
      "signupSourceOidc": "OIDC",
      "signupSourceGithub": "GitHub",
      "signupSourceGoogle": "Google",
      "signupSourceDingtalk": "钉钉",
      "signupSourceUnknown": "未知",
      "inviterLabel": "邀请人",
      "noInviter": "无",
      "amountSourceTotal": "累计入账",
      "amountSourceRecharge": "充值",
      "amountSourceRegistration": "注册赠送",
      "amountSourceInvitation": "邀请码",
      "amountSourceCheckin": "签到奖励",
      "amountSourceAffiliateTransfer": "返利转入",
      "amountSourceAdminAdjustment": "管理员调整",
      "filterSettings": "筛选设置",
      "columnSettings": "列设置",
      "filterValue": "输入值",
      "attributes": {
