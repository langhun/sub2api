export default {
  ...
  leaderboard: {
    ...
    subtitle: '查看当前活跃用户排行',
    empty: '暂无数据',
    tabsDisabled: '排行榜标签页已关闭',
    consumptionChartTitle: '消费分布',
    consumptionChartSubtitle: '查看当前周期所有消费用户的金额占比',
    totalAmount: '总金额',
    totalUsers: '用户数',
    hoverHint: '悬停图表切片可查看用户、金额和占比',
    requests: '请求',
    amount: '金额',
    share: '占比',
    streakDays: '{days} 天',
    balanceSubtitle: '{count} 次签到',
    consumptionSubtitle: '{count} 次请求',
    checkinSubtitle: '累计 {total} 次，上次 {date}，获得 ${reward}',
    transferCount: '笔转账',
    tabs: {
      balance: '余额排行',
      consumption: '消耗排行',
  ...
  admin: {
    ...
    monitoring: {
      title: '平台监控',
      description: '账号健康、模型延迟与请求量监控',
      todayRequests: '24 小时请求',
      avgLatency: '平均延迟',
      errorAccounts: '异常账号',
      totalGroups: '分组数',
      groupHealth: '分组账号健康',
      ...
      overload: '过载',
      disabled: '已禁用',
      modelLatency: '模型延迟（24 小时）',
      modelLatencyHint: '基于最近 24 小时的使用记录',
      model: '模型',
      requests: '请求',
      success: '成功',
      errors: '错误',
    ...
    backup: {
      ...
      s3: {
        ...
        secretAccessKey: '私密访问密钥（Secret Access Key）',
      ...
      r2Guide: {
        ...
        step1: {
          title: '创建 R2 存储桶',
          line1: '登录 Cloudflare 控制台 (dash.cloudflare.com)，左侧菜单选择「R2 对象存储」',
        ...
        step2: {
          ...
          line4: '创建后会显示访问密钥 ID（Access Key ID）和私密访问密钥（Secret Access Key）',
    ...
    accounts: {
      ...
      bedrockAccessKeyId: 'AWS 访问密钥 ID（Access Key ID）',
      bedrockSecretAccessKey: 'AWS 私密访问密钥（Secret Access Key）',
      bedrockSessionToken: 'AWS Session Token',
      bedrockRegion: 'AWS 区域（Region）',
      ...
      bedrockAccessKeyIdRequired: '请输入 AWS 访问密钥 ID（Access Key ID）',
      bedrockSecretAccessKeyRequired: '请输入 AWS 私密访问密钥（Secret Access Key）',
      bedrockRegionRequired: '请选择 AWS 区域（Region）',
    ...
    proxies: {
      ...
      poolMembersSummary: '当前有 {count} 个代理参与自动故障转移',
      poolMembersFilteredSummary: '正在显示 {visible}/{total} 个代理',
      poolMembersEmpty: '代理池中暂无代理',
      poolMembersFilteredEmpty: '没有代理匹配当前筛选条件',
      poolMembersMeta: '运行信息',
      poolMembersHealth: '健康状态',
      poolMembersSwitchCount: '切换次数',
      poolMembersRecovered: '最近恢复',
      poolMembersSearchPlaceholder: '搜索名称 / 地址 / 失败原因',
      poolToggleLabel: '参与自动故障转移代理池',
      poolToggleHint: '只有加入代理池的代理才会被 OpenAI 与 Antigravity 自动故障转移选择。',
      poolUsageSummary: 'OpenAI 与 Antigravity 账号会自动使用代理池',
      poolUsageHint: '账号当前代理失败时，系统会切换到代理池中的健康代理；账号没有代理时也可以直接从代理池选择。',
      poolBatchEnabled: '已将 {count} 个代理加入自动故障转移代理池',
      poolBatchDisabled: '已将 {count} 个代理移出自动故障转移代理池',
      poolSingleEnabled: '已将 {name} 加入自动故障转移代理池',
      poolSingleDisabled: '已将 {name} 移出自动故障转移代理池',
      poolUpdateFailed: '更新代理池失败',
      columns: {
        name: '名称',
        protocol: '协议',
        address: '地址',
      ...
      quickUnassignConfirm: '确定从账号中解绑选中的 {count} 个代理吗？这会清空当前使用这些代理的账号代理设置。',
      quickUnassignConfirmButton: '确认解绑',
      quickUnassignDone: '匹配 {matched} 个账号，已解绑 {unassigned} 个账号',
      quickUnassignFailed: '解绑账号代理失败',
      ...
      subscriptions: {
        ...
        manage: '代理订阅源',
        manageTitle: '代理订阅源管理',
        manageHint: '在这里管理订阅源刷新、节点查看、删除以及物化代理。',
        modalHint: '在这里管理订阅源刷新、节点查看、删除以及物化代理。',
        create: '新建订阅源',
        empty: '暂无代理订阅源',
        refreshInterval: '刷新间隔：{hours} 小时',
        targetEntryCount: '目标代理数：{count}',
        nodeCount: '节点：{count}',
        materializedCount: '已生成代理：{count}',
        lastRefreshed: '最近刷新：{time}',
        refreshNow: '立即刷新',
        viewNodes: '查看节点',
        managedBadge: '订阅源管理',
        managedReadonlyHint: '此代理由订阅源管理，连接字段只读，但仍可调整状态和代理池归属。',
        createTitle: '新建代理订阅源',
        editTitle: '编辑代理订阅源',
        nodesTitle: '订阅源节点',
        nodesEmpty: '暂无节点',
        refreshSuccess: '刷新完成：{nodes} 个节点，{proxies} 个代理',
        refreshFailed: '刷新订阅源失败',
        nodesLoadFailed: '加载订阅源节点失败',
        deleteSuccess: '订阅源已删除',
        deleteFailed: '删除订阅源失败',
        createSuccess: '订阅源已创建',
        createFailed: '创建订阅源失败',
        updateSuccess: '订阅源已更新',
      ...
      assignAccounts: {
        open: '均匀分配到账号',
        title: '均匀分配到账号',
        scopeHint: '已选择 {count} 个代理。目标账号仅限未设置代理的账号，执行时会再次校验，避免覆盖已有设置。',
        platforms: '平台筛选',
        statuses: '状态筛选',
        groups: '分组筛选',
        emptyMeansAll: '不选择表示全部。',
        noGroups: '暂无分组',
        groupOrHint: '多个分组按 OR 逻辑匹配；账号命中多个分组时只分配一次。',
        preview: '预览',
        previewing: '预览中...',
        execute: '分配',
        assigning: '分配中...',
        ...
        planned: '计划分配',
        actual: '实际分配',
        emptyTargets: '当前筛选条件下没有未设置代理的目标账号。',
        unnamedProxy: '未命名代理',
        proxyCountChange: '账号数 {before} -> {after}；计划 {planned}，实际 {assigned}',
        moreAccounts: '还有 {count} 个账号',
        previewFailed: '预览代理分配失败',
      ...
      qualityInterpretation: '解读',
      qualityInterpretationHealthy: '连通性健康，可参与调度。',
      qualityInterpretationWarn: '目标可访问，但存在认证或方法限制。',
      qualityInterpretationChallenge: '代理触发了上游防护挑战，稳定性可能不足。',
      qualityInterpretationFail: '至少一个目标检测失败，请排查该代理。',
      qualityItemMessageEmpty: '暂无额外说明',
      healthHealthy: '健康',
      healthCooldown: '冷却中',
      healthFailed: '失败',
      healthUnknown: '未知',
      ...
      failoverSwitchCount: '自动故障转移次数：{count}',
      lastFailure: '最近失败',
      lastRecoveredAt: '最近恢复：{time}',
      lastRecoveredEmpty: '暂无恢复记录',
    ...
    settings: {
      ...
      turnstile: {
        ...
        siteKey: '站点密钥',
        secretKey: '私密密钥',
        siteKeyHint: '从 Cloudflare 控制台获取',
        cloudflareDashboard: 'Cloudflare 控制台',
      ...
      oidc: {
        ...
        clientId: 'Client ID',
        clientIdPlaceholder: '例如：sub2api-web',
        clientSecret: '客户端密钥（Client Secret）',
        clientSecretPlaceholder: '********',
        clientSecretHint: '用于后端交换 token（请保密）',
        clientSecretConfiguredPlaceholder: '********',
      ...
      soraS3: {
        ...
        accessKeyRequired: '启用时必须填写访问密钥 ID（Access Key ID）',
        deleteConfirm: '确定删除存储配置 {profileID} 吗？',
        columns: {
          profile: '配置',
          profileId: '配置 ID（Profile ID）',
          name: '名称',
          provider: '存储类型',
          active: '生效状态',
          endpoint: '端点',
  ...
  pricing: {
    title: '模型定价',
    description: '查看所有分组及其模型的计费价格（每 100 万 Token）',
