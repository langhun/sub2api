  ...
  "admin": {
    ...
    "proxies": {
      ...
      "subscriptions": {
        ...
        "loadFailed": "加载节点订阅失败",
        "linkedBadge": "订阅托管",
        "modalHint": "节点订阅统一在这里维护，保存、刷新、删除后会更新代理列表。",
        "productHint": "该节点订阅会在刷新后生成代理入口，并同步到代理列表。",
        "create": "新建节点订阅",
        "empty": "暂无节点订阅",
        ...
        "statusPending": "待首次同步",
        "managedBadge": "订阅托管",
        "managedReadonlyHint": "该代理由节点订阅托管，连接字段只读。你仍然可以调整状态和代理池开关。",
        "createTitle": "节点订阅",
        "editTitle": "编辑节点订阅",
        "nodesTitle": "订阅节点",
        "nodesEmpty": "暂无节点",
        "refreshSuccess": "刷新完成：节点 {nodes}，代理 {proxies}",
        "refreshSyncSuccess": "刷新完成：节点 {nodes}，代理 {proxies}，新建 {created}，复用 {reused}",
        "refreshSyncPartial": "刷新完成，但代理入口同步失败：{detail}",
        "refreshFailed": "刷新节点订阅失败",
        "nodesLoadFailed": "加载订阅节点失败",
        "deleteSuccess": "节点订阅已删除",
        "deleteSyncSuccess": "节点订阅已删除，代理入口已同步（新建 {created}，复用 {reused}）",
        "deleteSyncPartial": "节点订阅已删除，但代理入口同步失败：{detail}",
        "deleteFailed": "删除节点订阅失败",
        "createSuccess": "节点订阅创建成功",
        "createSyncSuccess": "节点订阅创建成功，代理入口已同步（新建 {created}，复用 {reused}）",
        "createSyncPartial": "节点订阅创建成功，但代理入口同步失败：{detail}",
        "createFailed": "创建节点订阅失败",
        "updateSuccess": "节点订阅更新成功",
        "updateSyncSuccess": "节点订阅更新成功，代理入口已同步（新建 {created}，复用 {reused}）",
        "updateSyncPartial": "节点订阅更新成功，但代理入口同步失败：{detail}",
        "updateFailed": "更新节点订阅失败",
        "formSections": {
          "basic": "基础信息",
          "policy": "同步与落地策略"
        },
    ...
    "settings": {
      ...
      "gatewayForwarding": {
        ...
        "openaiAllowClaudeCodeCodexPluginDesc": "全局开关，仅影响已开启“仅允许 Codex 官方客户端”的 OpenAI OAuth 账号。开启后，这类账号会额外允许来自 Claude Code Codex 插件的请求（精确匹配 originator=Claude Code），不需要逐个账号配置，上游请求仍保持透传。"
      },
      "webSearchEmulation": {
        "title": "Web Search 模拟",
