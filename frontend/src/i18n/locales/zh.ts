export default {
  ...
  "bank": {
    "title": "金融中心",
    "description": "查看账户快照、信用容量和统一账本流水",
    "readonlyBadge": "只读预览",
    "refresh": "刷新金融数据",
    "accountSnapshot": "账户快照",
    "transactionLedger": "账本流水",
    "balance": "可用余额",
    ...
    "debtInterest": "待还利息",
    "status": "账户状态",
    "legacyMissing": "历史兼容账户",
    "legacyMissingYes": "待补齐",
    "legacyMissingNo": "已同步",
    "typeFilter": "交易类型",
    "moduleFilter": "业务模块",
    "allTypes": "全部类型",
    ...
    "reference": "关联凭证",
    "noTransactions": "暂无账本流水",
    "loadFailed": "加载金融中心失败",
    "transactionsLoadFailed": "加载账本流水失败",
    "statusMap": {
      "ACTIVE": "正常",
      "FROZEN": "冻结",
      "CLOSED": "关闭"
  ...
  "checkin": {
    ...
    "luckTitle": "运气签到",
    "luckButton": "运气签到",
    "luckDesc": "选择下注金额，获得 {min} ~ {max} 的随机倍率",
    "luckSuccess": "运气签到成功！倍率 x{multiplier}，获得 ${amount}",
    "luckLoss": "运气签到成功！倍率 x{multiplier}，失去 ${amount}",
    "luckEven": "运气签到成功！倍率 x1.00，不赚不赔",
    "luckCheckinReward": "运气签到奖励",
    "luckRewardTitle": "运气签到奖励 · 倍率 x{multiplier}",
    "betAmount": "下注金额",
    "betAmountPlaceholder": "输入下注金额",
    "multiplier": "倍率",
    "multiplierRange": "倍率范围 x{min} ~ x{max}",
    "selectType": "选择签到方式",
    "checkinType": "类型",
    "normalCheckin": "普通签到",
    "luckCheckin": "运气签到",
  ...
  "leaderboard": {
    ...
    "subtitle": "看看谁是活跃之星",
    "empty": "暂无数据",
    "tabsDisabled": "排行榜标签已关闭",
    "balanceChartTitle": "余额分布",
    "balanceChartSubtitle": "查看余额排行用户的金额占比",
    "consumptionChartTitle": "消费分布",
    "consumptionChartSubtitle": "查看当前周期所有消费用户的金额占比",
    "checkinChartTitle": "签到分布",
    "checkinChartSubtitle": "查看签到排行用户的连续天数占比",
    "totalAmount": "总金额",
    "totalUsers": "用户数",
    "hoverHint": "悬停圆环切片可查看用户、金额和占比",
    "checkinHoverHint": "悬停圆环切片可查看用户、连续天数和占比",
    "requests": "请求",
    "checkins": "签到",
    "totalCheckins": "累计签到",
    "streak": "连续天数",
  ...
  "admin": {
    ...
    "channels": {
      ...
      "loadError": "加载渠道列表失败",
      "emptyModelsInPricing": "该渠道暂无可定价模型",
      "noGroupsSelected": "请选择至少一个分组",
    ...
    "riskControl": {
      ...
      "preBlockSyncHint": "同步审核路径的实时计数，不包含异步记录任务。",
      "preBlockActive": "同步处理中",
      "preBlockActiveHint": "当前正在检查",
      "preBlockChecked": "已检查",
      "preBlockCheckedHint": "进入前置拦截路径",
      "preBlockAllowed": "已放行",
      "preBlockAllowedHint": "未触发拦截",
      "preBlockBlocked": "已拦截",
      "preBlockBlockedHint": "命中后已拒绝",
      "preBlockErrors": "审核异常",
      "preBlockErrorsHint": "失败或无可用 Key",
      "preBlockAvgLatency": "平均延迟",
      "preBlockAvgLatencyHint": "同步路径平均耗时",
      ...
      "workerStatusHint": "异步审核任务和前置拦截记录任务的队列和 worker 池状态，不包含同步前置拦截检查。",
      "workerPool": "Worker 池",
    ...
    "channelMonitor": {
      ...
      "loadError": "加载监控列表失败",
      "historyLoadError": "加载检测历史失败",
      "deleteConfirm": "确定要删除监控「{name}」吗？此操作不可撤销。",
      "nameRequired": "请输入监控名称",
      "primaryModelRequired": "请输入主模型",
      "pageStatusTitle": "自动测活状态",
      "pageStatusEnabled": "运行中",
      "pageStatusDisabled": "已关闭",
      "pageStatusDescription": "页面会自动刷新，你可以直接看到后台最近一次自动测活时间和结果。",
      "pageStatusDisabledDescription": "全局渠道监控当前已关闭，后台不会继续自动测活。",
      "autoRefreshHint": "页面刷新倒计时：{seconds}s",
      "columns": {
        "name": "名称",
        "provider": "供应商",
        "primaryModel": "主模型",
      ...
      "historySubtitle": "最近自动测活结果",
      "historyDescription": "这里展示该监控最近几次自动测活或手动检测的落库结果。",
      "historyAllModels": "全部模型",
      "historyEmpty": "还没有测活记录",
      "historyCheckedAt": "检测时间",
      "historyLatency": "模型延迟",
      "historyPingLatency": "Ping 延迟",
      "noMonitorsYet": "暂无监控",
    ...
    "accounts": {
      ...
      "proxy": "代理",
      "noProxy": "无代理",
      "proxyAutoFailoverAt": "{time} 前自动切换",
      "oauthType": "OAuth",
      "schedulable": "参与调度",
      ...
      "duplicateCheck": {
        "open": "重复账号检查",
        "title": "重复账号检查",
        "scopeHint": "默认扫描账号管理中的全部账号，不受当前分页影响；筛选项为空时表示不限。",
        "platforms": "平台筛选",
        "statuses": "状态筛选",
        "groups": "分组筛选",
        "emptyMeansAll": "不勾选表示全部。",
        "includeInactive": "包含停用和异常账号",
        "statusHint": "勾选具体状态后，将按勾选状态扫描；未勾选状态时按“包含停用和异常账号”决定范围。",
        "noGroups": "暂无分组",
        "run": "开始检查",
        "checking": "检查中...",
        "totalAccounts": "扫描账号",
        "duplicateAccounts": "重复账号",
        "groupsFound": "重复组",
        "strongGroups": "强重复",
        "weakGroups": "弱重复",
        "noDuplicates": "未发现重复账号。",
        "strong": "强重复",
        "weak": "弱重复",
        "groupScope": "{platform} / {type}，共 {count} 个账号",
        "accountId": "账号 ID",
        "failed": "重复账号检查失败",
        "idCopied": "账号 ID 已复制"
      },
      "affinityNoClients": "暂无亲和客户端",
      "affinityClients": "{count} 个亲和客户端：",
      "affinitySection": "客户端亲和性",
      "affinitySectionHint": "控制客户端在账号之间的分布。可配置分区阈值来平衡负载。",
      "affinityToggle": "启用客户端亲和性",
      "affinityToggleHint": "新会话优先使用该客户端之前命中过的账号",
      "affinityBase": "基础上限（绿色区）",
      "affinityBasePlaceholder": "留空 = 不限制",
      "affinityBaseHint": "绿色区最多客户端数（完整优先级调度）",
      "affinityBaseOffHint": "不限制绿色区。所有客户端都按完整优先级调度。",
      "affinityBuffer": "缓冲区（黄色区）",
      "affinityBufferPlaceholder": "例如 3",
      "affinityBufferHint": "黄色区额外允许的客户端数（降级优先级）",
      ...
      "status": {
        ...
        "streamTimeoutCooldown": "流超时冷却",
        "tokenRefreshCooldown": "刷新冷却",
        "quotaExceeded": "配额超限",
        "unschedulable": "不可调度",
        "schedulingActive": "当前参与调度",
        "manualPausedHint": "已手动关闭调度",
        "expiredPausedHint": "账号已过期并自动暂停",
        "quotaExceededHint": "配额已用尽，当前不参与调度",
        "rateLimitedUntil": "限流中，当前不参与调度，预计 {time} 自动恢复",
        "rateLimitedAutoResume": "{time} 自动恢复",
        "overloadedAutoResume": "{time} 自动恢复",
        "tempUnschedAutoResume": "{reason}，{time} 自动恢复",
      ...
      "statusGuide": {
        ...
        "runtimeNormal": "当前没有冷却或临时阻断",
        "runtimeRateLimited": "上游 429 限流，等待自动恢复",
        "runtimeOverloaded": "上游 529 过载，等待自动恢复",
        "runtimeTempUnschedulable": "临时冷却，包含很多 401 认证冷却场景",
        "runtimeOauth401Cooldown": "401 认证冷却，通常给 token 刷新或重新授权留窗口",
        "runtimeForbiddenCooldown": "403 冷却，通常表示短时拒绝或风控冷却",
        "runtimeHttpCooldown": "由上游 HTTP {code} 触发的临时冷却",
        "runtimeStreamTimeoutCooldown": "流式超时触发的临时冷却",
        "runtimeTokenRefreshCooldown": "刷新重试耗尽后进入的临时冷却",
        "runtimeQuotaExceeded": "账号配额已超限，当前不参与调度",
      ...
      "bulkActions": {
        ...
        "test": "批量测试",
        "testAllUngrouped": "一键测试未分组",
        "testUngroupedPrefix": "测试数量",
        "testUngroupedCountHint": "当前共 {total} 个",
        "resetStatus": "批量重置状态",
        "refreshToken": "批量刷新令牌",
        "setPrivacy": "批量设置隐私",
        "clearPrivacy": "批量清除隐私",
        "confirmSetPrivacy": "确认批量为所选账号设置隐私吗？仅 OpenAI OAuth 账号会处理。",
        "confirmClearPrivacy": "确认批量清除所选账号的隐私状态吗？仅 OpenAI OAuth 账号会处理。",
        "resetStatusSuccess": "已成功重置 {count} 个账号状态",
        "refreshTokenSuccess": "已成功刷新 {count} 个账号令牌",
        "setPrivacySuccess": "已成功设置 {count} 个账号的隐私",
        "clearPrivacySuccess": "已成功清除 {count} 个账号的隐私状态",
        "deleteSuccess": "已成功删除 {count} 个账号",
        "partialSuccess": "操作部分完成：{success} 成功，{failed} 失败",
        "partialSuccessWithSkipped": "操作部分完成：{success} 成功，{failed} 失败，{skipped} 跳过"
      },
      "batchTest": {
        "title": "批量测试账号",
        "total": "总数",
        ...
        "progress": "进度",
        "model": "测试模型",
        "defaultModelOption": "默认测试模型（按账号）",
        "concurrency": "测试并发",
        "concurrencyHint": "同时测试的账号数量，最大 {max}。",
        "selectModel": "请选择测试模型",
        "noCommonModels": "所选账号没有共同可用的测试模型",
        "modelLoadFailed": "加载测试模型失败",
        "loadTargetsFailed": "加载待测试账号失败",
        "noAccountsToTest": "当前筛选下没有可测试账号",
        "loadingTargets": "准备测试账号中...",
        "result": "结果",
        "resultFilterLabel": "结果筛选",
        "emptyFiltered": "当前筛选下没有测试结果",
        "start": "开始测试",
        "stop": "停止",
        "retry": "重新测试",
        "testing": "测试中...",
        "stopped": "已停止",
        "successMessage": "测试通过",
        "successWithModel": "测试通过：{model}",
        "successWithModelAndText": "测试通过：{model}，响应 {text}",
        "failedMessage": "测试失败",
        "incompleteStream": "测试流未正常结束",
        "noResponseBody": "测试响应为空",
      ...
      "openai": {
        ...
        "responsesModeTextDisabledHint": "未启用 Responses / Chat Completions 端点时不适用。",
        "endpointCapabilities": "端点能力",
        "endpointCapabilitiesDesc": "用于账号路由。文本端点跟随上方 Responses API 支持设置，并显示为 Responses、Chat Completions 或自动模式；Embeddings 单独控制 /v1/embeddings。",
        ...
        "codexCLIOnlyAllowClaudeCode": "同时允许 Claude Code 的 Codex 插件",
        "codexCLIOnlyAllowClaudeCodeDesc": "仅在上方开关开启时生效。额外允许来自 Claude Code Codex 插件的请求（originator=Claude Code 精确匹配），不会放宽对其它非官方客户端的拦截。",
        "codexImageGenerationBridge": "Codex 图片生成桥接",
      ...
      "proxyRouteHint": "为当前账号明确指定直连、单代理或自动代理池。",
      "proxyModeDirectLabel": "不使用代理",
      "proxyModeDirectDesc": "始终直连，不参与代理池切换",
      "proxyModeSingleLabel": "指定代理",
      "proxyModeSingleDesc": "固定使用一个代理，可手动选择",
      "proxyModePoolLabel": "代理池",
      "proxyModePoolDesc": "从自动切换代理池中选择可用代理",
      "proxyModeDirectNotice": "当前账号将直连上游，不会自动走代理池。",
      "proxyModePoolNotice": "当前账号将走自动代理池。当前入池代理数：{count}。",
      "proxyModePoolEmpty": "当前代理池里还没有代理。请先到代理管理里把代理加入自动切换池。",
      "selectProxyForSingleMode": "请选择一个代理，或改为“不使用代理 / 代理池”。",
      "concurrency": "并发数",
      "loadFactor": "负载因子",
    ...
    "scheduledTests": {
      ...
      "deleteOnConfirmed401": "401 持续失败后删除",
      "deleteOnConfirmed401Help": "先进入错误，后续定时测试仍 401 再删除；测试成功则自动放出。",
      "switchGroupFrom": "429 切组来源分组",
      "switchGroupTo": "429 切组目标分组",
      "actionTaken": "执行动作",
      "attemptNo": "第 {value} 次"
    },
    "proxies": {
      ...
      "enableAction": "启用代理",
      "disableAction": "停用代理",
      "poolEnableAction": "加入代理池",
      "poolDisableAction": "移出代理池",
      "poolMembersAction": "查看代理池",
      "poolMembersTitle": "代理池成员",
      "poolMembersSummary": "当前代理池共有 {count} 个代理",
      "poolMembersFilteredSummary": "当前显示 {visible} / {total} 个代理",
      "poolMembersEmpty": "当前代理池里还没有代理",
      "poolMembersFilteredEmpty": "当前筛选条件下没有匹配的代理",
      "poolMembersMeta": "运行信息",
      "poolMembersHealth": "健康状态",
      "poolMembersSwitchCount": "切换命中",
      "poolMembersRecovered": "最近恢复",
      "poolMembersSearchPlaceholder": "搜索名称 / 地址 / 失败原因",
      "poolToggleLabel": "参与自动切换代理池",
      "poolToggleHint": "只有加入该池的代理，才会被 OpenAI 和 Antigravity 的自动故障转移选中。",
      "poolUsageSummary": "OpenAI / Antigravity 账号会自动使用代理池",
      "poolUsageHint": "如果账号当前代理失败，会自动切换到池内健康代理；如果账号没有绑定代理，也会直接从池里选择可用代理。",
      "poolBatchEnabled": "已将 {count} 个代理加入自动切换代理池",
      "poolBatchDisabled": "已将 {count} 个代理移出自动切换代理池",
      "poolSingleEnabled": "已将 {name} 加入自动切换代理池",
      "poolSingleDisabled": "已将 {name} 移出自动切换代理池",
      "batchBarHint": "批量操作栏",
      "selectedCount": "已选择 {count} 个",
      "toolsSummary": "工具概览",
      "toolsSummarySelected": "已选 {count} 个工具",
      "clearCooldownBatch": "清除冷却",
      "poolBatchEnable": "加入自动切换代理池",
      "poolBatchDisable": "移出自动切换代理池",
      "poolUpdateFailed": "更新代理池成员失败",
      "searchProxies": "搜索代理...",
      "protocols": {
        "http": "HTTP",
        "https": "HTTPS",
      ...
      "quickUnassign": "快速取消代理",
      "batchDelete": "批量删除",
      "batchDeleteConfirm": "确定删除选中的 {count} 个代理吗？已被账号使用的将自动跳过。",
      "quickUnassignConfirm": "确定取消选中的 {count} 个代理与账号的绑定吗？这会清空这些代理下所有账号的代理设置。",
      "quickUnassignConfirmButton": "取消代理",
      "quickUnassignDone": "已匹配 {matched} 个账号，成功取消 {unassigned} 个账号的代理绑定",
      "quickUnassignFailed": "快速取消代理失败",
      ...
      "mihomo": {
        "title": "Mihomo",
        "manage": "多端口代理",
        "multiPortTitle": "多端口代理",
        "multiPortDescription": "本地多端口代理分配",
        "summaryPorts": "{count} 个端口",
        "summaryProtocol": "协议 {protocol}",
        "summaryConfigFile": "配置文件 {path}",
        "configPathPending": "待同步生成",
        "configure": "配置",
        "syncToProxy": "同步到代理",
        "summary": "统一复用订阅源生成 Mihomo 多端口入口",
        "summaryHint": "{count} 个监听入口",
        "sourceCountHint": "启用源 {count} 个",
        "sourceNodesHint": "启用源节点 {count} 个",
        "protocolLabel": "协议：{protocol}",
        "sourcePanelTitle": "代理源",
        "sourceNamePlaceholder": "订阅源名称",
        "sourceUrlPlaceholder": "订阅源 URL",
        "sourcePanelHint": "这里直接使用下方订阅源作为多端口代理的数据源，避免再维护第二套配置。",
        "autoRouteTitle": "自动优选线路",
        "autoRouteDescription": "开启后由 Mihomo 根据延迟自动挑选可用线路，适合日常稳定运行。",
        "failoverTolerance": "切换容差（ms）",
        "healthCheckInterval": "检测间隔（秒）",
        "excludeNodesTitle": "排除节点",
        "excludeNodesDescription": "用于记录不希望参与自动优选的节点关键词，当前仅作为界面策略提示，不写入后端配置。",
        "excludeNodesPlaceholder": "每行一个关键词，例如：\n香港\nHong Kong\nHK\nHKG",
        "listenerPanelTitle": "监听端口",
        "listenerLineTitle": "端口 {port} 线路",
        "sourceHint": "直接复用下方订阅源作为唯一数据源，不再单独维护第二套订阅 URL。订阅源在这里保存、刷新、删除后会自动联动同步到 Mihomo。",
        "workspaceTitle": "统一入口工作台",
        "workspaceDescription": "把订阅源、Provider 生成、Mihomo 监听入口放进同一套产品界面，集中完成配置、同步与排错。",
        "workspaceStatus": "最近联动刷新",
        "workspaceStatusEmpty": "暂无刷新记录",
        "statusBadge": {
          "loading": "加载中",
          "error": "异常",
          "warning": "待处理",
        ...
        "statusMessage": {
          "loading": "正在加载工作台数据，请稍候。",
          "healthy": "当前工作台状态正常，可以继续保存或同步。",
          "latestRefresh": "最近联动刷新：{time}",
          "noEnabledSources": "当前没有启用的数据源，无法继续联动同步。",
          "sourceErrors": "{count} 个数据源存在异常，请先处理后再同步。",
          "listenerIncomplete": "{count} 个监听入口还没有设置地区偏好。",
          "disabledSources": "{count} 个数据源当前处于禁用状态。"
        },
        "refreshSources": "刷新数据源",
        "listenerCompletion": "监听入口 {ready}/{total} 已完成",
        "flow": {
          "sourcesTitle": "1. 订阅源",
          "sourcesDesc": "维护唯一数据源，直接承接新建、编辑、刷新和删除操作。",
          "providersTitle": "2. Provider 构建",
          "providersDesc": "后端按启用订阅源生成 Provider 文件，作为 Mihomo 唯一输入。",
          "listenersTitle": "3. 本地入口",
          "listenersDesc": "把节点编排成多端口监听入口，并同步落地到代理列表。"
        },
        "overview": {
          "sources": "启用数据源",
          "sourcesHint": "当前参与 Mihomo 构建的订阅源数量",
          "listeners": "监听入口",
          "listenersHint": "从端口 {start} 开始顺序生成",
          "nodes": "可用节点",
          "nodesHint": "启用源刷新后汇总的节点总量",
          "materialized": "已落地入口",
          "materializedHint": "当前已同步到代理表的入口数",
          "errorsHint": "{count} 个数据源存在异常，需要处理"
        },
        "sourceSectionTitle": "统一数据源",
        "sourceSectionDescription": "所有订阅源都在这里维护。新增、编辑、刷新、删除后，会继续联动 Mihomo 和代理表。",
        "sourceHealthTitle": "当前源健康度",
        "sourceHealthNormal": "没有检测到需要处理的数据源异常。",
        "sourceHealthError": "{count} 个数据源处于异常状态。",
        "sourceActionHintTitle": "建议操作",
        "sourceActionHint": "先处理异常源，再执行保存并同步，结果会更稳定。",
        "sourceMetaTitle": "最近联动信息",
        "sourceSectionStats": "总计 {total} 个订阅源，已启用 {enabled} 个",
        "sourceSectionNodeStats": "当前汇总 {count} 个节点，已落地 {materialized} 个入口",
        "sourceSectionEmpty": "还没有可用订阅源。先新增一个订阅源，再统一同步到 Mihomo。",
        "configSectionTitle": "Mihomo 运行配置",
        "configSectionDescription": "右侧只保留运行参数与监听规划，避免和数据源操作混在一起。",
        "configGroups": {
          "connection": "连接与命名",
          "listeners": "监听入口",
          "strategy": "地理位置优选"
        },
        "optimizeSectionTitle": "策略与优化",
        "listenerSectionTitle": "地理位置分配",
        "listenerSectionDescription": "这里和代理列表的“地理位置”使用同一套表达：左侧是端口入口，右侧填写要优选的国家/地区/城市；填写后会优先于上方默认地理位置。",
        "listenerSummaryTitle": "监听入口摘要",
        "listenerSummaryDescription": "先看入口是否完整，再往下编辑具体地区偏好，避免逐项检查。",
        "listenerSummaryReady": "已完成入口",
        "listenerSummaryMissing": "待补位置",
        "listenerSummaryMissingValue": "还有 {count} 个入口待补地理位置",
        "listenerSummaryMissingNone": "所有入口都已设置地理位置",
        "listenerStatusReady": "已完成",
        "listenerStatusPending": "待补全",
        "listenerPortLabel": "端口 {port}",
        "listenerRegionLabel": "地理位置",
        "listenerGenerateTitle": "监听生成参数",
        "listenerGenerateDescription": "先确定起始端口和监听数量，再逐项补完地区偏好。",
        "saveHint": "保存配置只更新 Mihomo 运行参数；保存并同步会基于当前启用订阅源重建 Provider、端口入口，并同步回代理列表。",
        "subscriptionUrls": "订阅地址",
        "subscriptionUrlsHint": "每行一个订阅 URL。同步后会生成 Mihomo 配置，并在代理列表里创建本地入口。",
        "targetHost": "代理目标主机",
        "controllerUrl": "Mihomo Controller URL",
        "startPort": "起始端口",
        "listenerCount": "监听数量",
        "proxyNamePrefix": "代理名称前缀",
        "listenerPorts": "监听端口",
        "listenerRegion": "端口 {port} 的地理位置",
        "regionAuto": "自动选择",
        "regionPlaceholder": "选择或输入地理位置",
        "selectLocation": "默认地理位置",
        "locationPlaceholder": "输入或选择地理位置",
        "locationDisabledByAutoOptimize": "已启用自动优选策略，默认地理位置暂不参与；需要固定位置时关闭自动优选。",
        "autoOptimize": "自动优化",
        "countryOptimize": "按地理位置优化",
        "optimizeSettings": "优化设置",
        "enableAutoOptimize": "启用自动优化",
        "autoOptimizeHint": "生成 url-test 策略组，由 Mihomo 按延迟自动选择可用节点。",
        "applyAutoOptimize": "自动优选策略",
        "selectCountry": "默认地理位置",
        "countryPlaceholder": "输入或选择地理位置",
        "applyRecommendedCountry": "自动优选位置",
        "recommendedCountryHint": "推荐使用：{country}",
        "recommendedLocationHint": "推荐使用：{location}",
        "recommendedCountryEmpty": "暂无可用地理位置，保存同步后会继续从配置里补全。",
        "autoFillListenerRegions": "自动填充位置",
        "save": "保存配置",
        "saveAndSync": "保存并同步",
        "loadFailed": "加载 Mihomo 配置失败",
        "saveSuccess": "Mihomo 配置已保存",
        "saveFailed": "保存 Mihomo 配置失败",
        "syncSuccess": "Mihomo 已同步：新建 {created}，复用 {reused}",
        "syncFailed": "同步 Mihomo 失败"
      },
      "subscriptions": {
        "title": "订阅源管理",
        "tab": "订阅源",
        "manage": "Mihomo 订阅",
        "manageTitle": "Mihomo 订阅",
        "manageHint": "集中管理代理订阅源；保存、刷新或删除后会同步更新代理列表和 Mihomo 配置。",
        "loadFailed": "加载订阅源失败",
        "linkedBadge": "已整合到 Mihomo",
        "modalHint": "直接复用这里的订阅源作为唯一数据源；保存、刷新、删除后会自动联动同步 Mihomo。",
        "productHint": "该订阅源会直接参与 Mihomo Provider 构建；保存后将继续联动同步到统一入口。",
        "create": "新建订阅源",
        "empty": "暂无订阅源",
        "refreshInterval": "刷新间隔: {hours}h",
        "targetEntryCount": "落地入口数: {count}",
        "nodeCount": "节点数: {count}",
        "materializedCount": "已落地入口: {count}",
        "nodeMetricTitle": "节点总量",
        "targetMetricTitle": "目标入口",
        "refreshMetricTitle": "刷新周期",
        "lastRefreshed": "最近刷新: {time}",
        "lastRefreshedEmpty": "最近刷新: 暂无",
        "lastSuccess": "最近成功: {time}",
        "lastSuccessEmpty": "最近成功: 暂无",
        "refreshNow": "立即刷新",
        "viewNodes": "查看节点",
        "statusHealthy": "联动正常",
        "statusError": "同步异常",
        "statusPending": "待首次同步",
        "managedBadge": "订阅托管",
        "managedReadonlyHint": "该代理由订阅源托管，连接字段只读。你仍然可以调整状态和代理池开关。",
        "createTitle": "新建订阅源",
        "editTitle": "编辑订阅源",
        "nodesTitle": "订阅节点",
        "nodesEmpty": "暂无节点",
        "refreshSuccess": "刷新完成：节点 {nodes}，代理 {proxies}",
        "refreshSyncSuccess": "刷新完成：节点 {nodes}，代理 {proxies}；Mihomo 已联动同步（新建 {created}，复用 {reused}）",
        "refreshSyncPartial": "刷新完成，但 Mihomo 联动同步失败：{detail}",
        "refreshFailed": "刷新订阅源失败",
        "nodesLoadFailed": "加载订阅节点失败",
        "deleteSuccess": "订阅源已删除",
        "deleteSyncSuccess": "订阅源已删除，并已联动同步 Mihomo（新建 {created}，复用 {reused}）",
        "deleteSyncPartial": "订阅源已删除，但 Mihomo 联动同步失败：{detail}",
        "deleteFailed": "删除订阅源失败",
        "createSuccess": "订阅源创建成功",
        "createSyncSuccess": "订阅源创建成功，并已联动同步到 Mihomo（新建 {created}，复用 {reused}）",
        "createSyncPartial": "订阅源创建成功，但 Mihomo 联动同步失败：{detail}",
        "createFailed": "创建订阅源失败",
        "updateSuccess": "订阅源更新成功",
        "updateSyncSuccess": "订阅源更新成功，并已联动同步到 Mihomo（新建 {created}，复用 {reused}）",
        "updateSyncPartial": "订阅源更新成功，但 Mihomo 联动同步失败：{detail}",
        "updateFailed": "更新订阅源失败",
        "formSections": {
          "basic": "基础信息",
          "policy": "同步与落地策略"
        },
        "fields": {
          ...
          "url": "订阅链接",
          "format": "格式",
          "refreshIntervalHours": "刷新间隔（小时）",
          "targetEntryCount": "落地入口数量",
          "autoAddToPool": "自动加入代理池"
        },
        "formats": {
          "auto": "自动识别",
          "directList": "直连代理列表",
          "uriList": "URI 列表 / Base64",
      ...
      "assignAccounts": {
        "open": "平均分配到账号",
        "title": "平均分配到账号",
        "scopeHint": "已选 {count} 个代理。目标账号默认只包含未绑定代理的账号，执行时仍会再次校验，避免覆盖已有代理。",
        "platforms": "平台筛选",
        "statuses": "状态筛选",
        "groups": "分组筛选",
        "emptyMeansAll": "不勾选表示全部。",
        "noGroups": "暂无分组",
        "groupOrHint": "多分组使用 OR 逻辑；同一账号命中多个分组只分配一次。",
        "preview": "预览分配",
        "previewing": "预览中...",
        "execute": "执行分配",
        "assigning": "分配中...",
        ...
        "planned": "计划分配",
        "actual": "实际分配",
        "emptyTargets": "当前筛选条件下没有未绑定代理的目标账号。",
        "unnamedProxy": "未命名代理",
        "proxyCountChange": "账号数 {before} → {after}；计划 {planned}，实际 {assigned}",
        "moreAccounts": "另有 {count} 个账号",
        "previewFailed": "代理分配预览失败",
        "assignSuccess": "已分配 {count} 个账号",
        "assignFailed": "代理分配失败"
      },
      "standardAdd": "标准添加",
      "batchAdd": "快捷添加",
      ...
      "qualityScoreLabel": "评分",
      "qualityGradeLabel": "等级",
      "qualityExitIP": "出口 IP",
      "qualityCountry": "出口地区",
      "qualityBaseLatency": "基础延迟",
      "qualityCheckedAt": "检测时间",
      "qualityInterpretation": "结果解读",
      ...
      "qualityInterpretationHealthy": "目标连通性正常，可直接用于调度。",
      "qualityInterpretationWarn": "目标可达，但部分平台要求鉴权或方法受限。",
      "qualityInterpretationChallenge": "代理出口触发了防护挑战，稳定性存在风险。",
      "qualityInterpretationFail": "存在未通过的检测项，建议排查代理可用性。",
      "qualityItemMessageEmpty": "暂无附加说明",
      "healthHealthy": "健康",
      "healthCooldown": "冷却中",
      "healthFailed": "异常",
      "healthUnknown": "未知",
      "cooldownUntil": "冷却剩余：{time}",
      "cooldownExpired": "已结束",
      "clearCooldownAction": "清除冷却",
      "cooldownClearedSingle": "代理冷却已清除",
      "cooldownClearedBatch": "已清除 {count} 个代理的冷却状态",
      "cooldownClearFailed": "清除代理冷却失败",
      "failoverSwitchCount": "自动切换命中：{count}",
      "lastFailure": "最近失败",
      "lastRecoveredAt": "最近恢复：{time}",
      "lastRecoveredEmpty": "尚无恢复记录",
      ...
      "failedToToggle": "切换代理状态失败",
      "failedToTest": "测试代理失败",
      "nameRequired": "请输入代理名称",
      "hostRequired": "请输入主机地址",
      "portInvalid": "端口必须在 1-65535 之间",
      "deleteConfirm": "确定要删除代理 '{name}' 吗？仅未被账号使用的代理可以删除，如需解除绑定请先执行“快速取消代理”。"
    },
    "redeem": {
      "title": "兑换码管理",
      ...
      "userPrefix": "用户 #{id}",
      "sourceUnknown": "暂无来源记录",
      "winnerLine": "中奖用户：{user}",
      "prizeLine": "奖品：{prize}",
      "usedByLine": "注册使用：{user}",
      "inviterLine": "邀请人：{user}",
    ...
    "ops": {
      ...
      "settings": {
        ...
        "slowTailIsolation": "Slow Tail 隔离",
        "enableSlowTailIsolation": "启用 Slow Tail 隔离",
        "slowTailIsolationHint": "按窗口内 P95 慢请求自动临时下线高延迟账号；duration / 回写阈值填 0 表示关闭该维度。",
        "slowTailWindowMinutes": "统计窗口（分钟）",
        "slowTailMinRequests": "最小样本数",
        "slowTailTempUnschedMinutes": "临时不可调度时长（分钟）",
        "slowTailMaxAccountsPerRun": "单次最多隔离账号数",
        ...
        "validation": {
          ...
          "slowTailWindowMinutesRange": "Slow Tail 统计窗口必须在 1-120 分钟之间",
          "slowTailMinRequestsRange": "Slow Tail 最小样本数必须在 1-100 之间",
          "slowTailTTFTP95ThresholdRange": "Slow Tail 的 TTFT P95 阈值必须在 100-120000 毫秒之间",
          "slowTailDurationP95ThresholdRange": "Slow Tail 的 Duration P95 阈值必须在 0-600000 毫秒之间",
          "slowTailResponseLatencyP95ThresholdRange": "Slow Tail 的回写 P95 阈值必须在 0-600000 毫秒之间",
          "slowTailTempUnschedMinutesRange": "Slow Tail 临时不可调度时长必须在 1-1440 分钟之间",
          "slowTailMaxAccountsPerRunRange": "Slow Tail 单次最多隔离账号数必须在 1-100 之间",
    ...
    "transfer": {
      ...
      "revoke": "撤回",
      "freezeTitle": "冻结转账",
      "freezeConfirm": "确认冻结此笔转账？冻结后接收方余额将被扣除并退回发送方。",
      "revokeTitle": "撤回转账",
      "revokeConfirm": "确认撤回此笔转账？",
      "searchUser": "搜索邮箱/用户名",
      "amount": "金额",
      "addTarget": "添加目标",
    ...
    "settings": {
      ...
      "features": {
        ...
        "transfer": {
          "title": "转账设置",
          "enabled": "启用转账功能",
          "enabledHint": "关闭后用户端转账入口将隐藏。",
          "dailyLimit": "每日限额",
          "dailyCountLimit": "每日次数限制",
          "feeRate": "手续费率（%）",
          "feeRateHint": "转账时按比例扣除手续费。",
          "minAmount": "最小转账金额",
          "maxAmount": "最大转账金额",
          "redpacketEnabled": "启用红包转账",
          "redpacketEnabledHint": "关闭后红包入口隐藏。",
          "redpacketExpireHours": "红包过期时间（小时）",
          "redpacketExpireHoursHint": "超过该时间未领取则自动失效。",
          "redpacketMaxCount": "红包最大个数",
          "vipFeeExempt": "VIP 免手续费",
          "vipFeeExemptHint": "开启后 VIP 用户转账免手续费。"
        },
        "riskControl": {
          "title": "风控中心",
        ...
        "affiliate": {
          ...
          "customUsers": {
            ...
            "clearTitle": "清除专属配置",
            "clearMessage": "确定要清除该用户的专属邀请码和专属返利比例吗？",
            "addButton": "添加专属用户",
      ...
      "defaults": {
        ...
        "defaultPlatformQuotas": "默认平台额度（注册时分配）",
      ...
      "site": {
        ...
        "homeNavLeaderboardEnabled": "显示排行榜入口",
        "homeNavLeaderboardEnabledHint": "在公开首页顶部显示或隐藏排行榜入口。",
        "homeNavKeyUsageEnabled": "显示用量查询入口",
        "homeNavKeyUsageEnabledHint": "在公开首页顶部显示或隐藏用量查询入口。",
        "homeNavMonitoringEnabled": "显示平台监控入口",
        "homeNavMonitoringEnabledHint": "在公开首页顶部显示或隐藏平台监控入口。",
        "homeNavPricingEnabled": "显示模型定价入口",
        "homeNavPricingEnabledHint": "在公开首页顶部显示或隐藏模型定价入口。",
        "leaderboardTabsTitle": "排行榜页标签",
        "leaderboardTabsHint": "分别控制排行榜页面内四个标签是否展示。",
        "leaderboardBalanceEnabled": "显示余额排行标签",
        "leaderboardBalanceEnabledHint": "在排行榜页面显示或隐藏余额排行。",
        "leaderboardConsumptionEnabled": "显示消耗排行标签",
        "leaderboardConsumptionEnabledHint": "在排行榜页面显示或隐藏消耗排行。",
        "leaderboardTransferEnabled": "显示转账排行标签",
