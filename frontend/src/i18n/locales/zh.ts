  ...
  "admin": {
    ...
    "proxies": {
      ...
      "subscriptions": {
        ...
        "loadFailed": "加载订阅源失败",
        "linkedBadge": "订阅源托管",
        "modalHint": "订阅源统一在这里维护，保存、刷新、删除后会更新代理列表。",
        "productHint": "该订阅源会在刷新后生成代理入口，并同步到代理列表。",
        "create": "新建订阅源",
        "empty": "暂无订阅源",
        ...
        "deleteSyncSuccess": "订阅源已删除，代理入口已同步（新建 {created}，复用 {reused}）",
        "deleteSyncPartial": "订阅源已删除，但代理入口同步失败：{detail}",
        "deleteFailed": "删除订阅源失败",
        "createSuccess": "订阅源创建成功",
        "createSyncSuccess": "订阅源创建成功，代理入口已同步（新建 {created}，复用 {reused}）",
        "createSyncPartial": "订阅源创建成功，但代理入口同步失败：{detail}",
        "createFailed": "创建订阅源失败",
        "updateSuccess": "订阅源更新成功",
        "updateSyncSuccess": "订阅源更新成功，代理入口已同步（新建 {created}，复用 {reused}）",
        "updateSyncPartial": "订阅源更新成功，但代理入口同步失败：{detail}",
