export const activityLocaleMessages = {
  en: {
    ...
    checkin: {
      ...
      betAmount: 'Bet amount', betAmountPlaceholder: 'Enter an amount', multiplierRange: 'Multiplier range ${min}x - ${max}x', luckRiskNotice: 'Lucky check-in is settled at random. Your balance may increase or decrease; participate only within an amount you can afford to lose.',
  ...
  zh: {
    ...
    checkin: {
      ...
      betAmount: '下注金额', betAmountPlaceholder: '输入下注金额', multiplierRange: '倍率范围 ${min}x - ${max}x', luckRiskNotice: '运气签到为随机结算，余额可能增加，也可能减少，请按可承受范围参与。',
