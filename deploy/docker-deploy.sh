...
GITHUB_RAW_REPO_URL="https://raw.githubusercontent.com/Wei-Shaw/sub2api/main"
...
main() {
    ...
    # Download local-directory compose template and save as default docker-compose.yml
